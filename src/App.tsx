...
export default function App() {
  ...
  const regionToCities: { [key: string]: string[] } = {
    ...
    "בקעה": ["ארגמן", "אש קודש", "בית חגלה", "בקעות", "בתרונות", "גיתית", "גלגל", "החווה של אורי כהן", "החווה של יאיא", "החווה של מנחם", "החווה של עשהאל", "חוות גנות", "חוות הרשאש", "חוות יד השומר", "חוות עמיאל", "חוות פריאל", "חמדת", "חמרה", "ייט''ב", "יפית", "מבואות יריחו", "מחולה", "מכורה", "מעלה אפרים", "מצפור פצאל", "משואה", "משכיות", "נעמה", "נערן", "נתיב הגדוד", "עינות קדם", "פצאל", "צומת אלמוג", "קדם ערבה", "רועי", "רותם", "שדמות מחולה", "שלומציון", "תומר"],
    "בקעת בית שאן": ["בית אלפא וחפציבה", "בית השיטה", "בית יוסף", "בית שאן", "גני חוגה", "גשר", "חמדיה", "טייבה בגלבוע", "טירת צבי", "ירדנה", "כפר גמילה מלכישוע", "כפר רופין", "מולדת", "מירב", "מנחמיה", "מסילות", "מעוז חיים", "מעלה גלבוע", "נוה איתן", "נווה אור", "ניר דוד", "עין הנצי''ב", "רוויה", "רחוב", "שדה אליהו", "שדה נחום", "שדי תרומות", "תל תאומים"],
    "גולן דרום": ["אבני איתן", "אזור תעשייה בני יהודה", "אזור תעשייה צמח", "אלוני הבשן", "אלי עד", "אלמגור", "אניעם", "אפיק", "אשדות יעקב", "בני יהודה וגבעת יואב", "גשור", "האון", "חד נס", "חמת גדר", "חספין", "יונתן", "כנף", "כפר חרוב", "מבוא חמה", "מיצר", "מסדה", "מעגן", "מעלה גמלא", "נאות גולן", "נוב", "נטור", "עין גב", "צמח", "קדמת צבי", "קצרין", "קצרין - אזור תעשייה", "קשת", "רמות", "רמת מגשימים", "שער הגולן", "תל קציר"],
    "גולן צפון": ["אודם", "אורטל", "אל רום", "בוקעתא", "מג'דל שמס", "מסעדה", "מרום גולן", "נווה אטי''ב", "נמרוד", "עין זיוון", "עין קנייא", "קלע אלון", "רמת טראמפ", "שעל"],
    "גליל עליון": ["אבו סנאן", "אור הגנוז", "אזור תעשייה חצור הגלילית", "אזור תעשייה כרמיאל", "אזור תעשייה צ.ח.ר", "אזור תעשייה שער נעמן", "אחיהוד", "איילת השחר", "אליפלט", "אמירים", "אמנון", "אפק", "אשרת", "בוסתן הגליל", "ביריה", "בית ג'אן", "בית העלמין החדש עכו", "בית העמק", "בענה", "בר יוחאי", "ג'דידה מכר", "ג'וליס", "גדות", "גיתה", "דיר אל-אסד", "הר חלוץ", "הר-חלוץ", "חולתה", "חמדת ימים", "חצור הגלילית", "חרשים", "טובא זנגריה", "טל - אל", "טל-אל", "ינוח ג'ת", "ינוח-ג'ת", "יסוד המעלה", "יסעור", "ירכא", "כורזים ורד הגליל", "כחל", "כישור", "כליל", "כמון - כמאנה מזרחית", "כסרא סמיע", "כפר הנשיא", "כפר יאסיף", "כפר מסריק", "כפר שמאי", "כרכום", "כרמיאל", "לבון", "לוחמי הגטאות", "לפידות", "מג'דל כרום", "מגדל תפן", "מזרעה", "מחניים", "מירון", "מנחת מחניים", "מרכז אזורי מרום גליל", "מרכז אזורי רמת כורזים", "משמר הירדן", "נחף", "נס עמים", "נתיב השיירה", "סאג'ור", "ספסופה - כפר חושן", "עין אל אסד", "עין המפרץ", "עכו", "עכו - אזור תעשייה", "עכו - רמות ים", "עמוקה", "עמיעד", "עמקה", "פלך", "פרוד", "צורית גילון", "צפת - נוף כנרת", "צפת - עיר", "צפת - עכברה", "קדיתא", "קדרים", "ראמה", "ראש פינה", "רגבה", "שבי ציון", "שדה אליעזר", "שזור", "שייח' דנון", "שמרת", "שפר", "תובל"],
    "גליל תחתון": ["אזור תעשייה בר-לב", "אזור תעשייה קדמת גליל", "אזור תעשייה תרדיון", "אלומות", "אפיקים", "ארבל", "אתר ההנצחה גולני", "בית זרע", "בית ירח", "גבעת אבני", "גינוסר", "דגניה א", "דגניה ב", "הודיות", "הזורעים", "ואדי אל חמאם", "חוקוק", "טבריה", "יבנאל", "כינרת מושבה", "כינרת קבוצה", "כפר זיתים", "כפר חיטים", "כפר כמא", "כפר נהר הירדן", "לביא", "לבנים", "מגדל", "מצפה", "נבי שועייב", "פוריה כפר עבודה", "פוריה נווה עובד", "פוריה עילית", "רביד", "שדה אילן", "שרונה"],
    ...
    "דרום הנגב": ["'ביר הדאג", "אבו קרינאת", "אבו קרינאת והפזורה", "אבו תלול", "אבו-תלול והפזורה", "אזור תעשייה דימונה", "אזור תעשייה רותם", "אל פורעה", "אשלים", "באר מילכה", "ביר הדאג'", "דימונה", "ואדי אל נעם דרום", "חירן", "טללים", "ירוחם", "כמהין", "כסייפה", "כסייפה והפזורה", "כפר הנוקדים", "מדרשת בן גוריון", "מצפה רמון", "מרחב עם", "מרעית", "משאבי שדה", "ניצנה", "סעווה", "עזוז", "ערד", "ערערה בנגב", "קדש ברנע", "קסר א-סר", "רביבים", "רתמים", "שאנטי במדבר", "שדה בוקר", "תל ערד"],
    ...
    "העמקים": ["אורנים", "אזור תעשייה אלון התבור", "אזור תעשייה מבואות הגלבוע", "אזור תעשייה ציפורית", "אחוזת ברק", "אילניה", "אכסאל", "אלון הגליל", "אלוני אבא", "אלונים", "בית לחם הגלילית", "בית קשת", "בית שערים", "בלפוריה", "בסמת טבעון", "גבעת אלה", "גבת", "גדעונה", "גזית", "גן נר", "גניגר", "דבוריה", "דברת", "דחי", "הושעיה", "היוגב", "הסוללים", "הרדוף", "זרזיר", "חג'אג'רה", "טמרה בגלבוע", "יזרעאל", "יפיע", "יפעת", "ישובי אומן", "ישובי יעל", "כדורי", "כעביה טבאש", "כפר ברוך", "כפר גדעון", "כפר החורש", "כפר ח'וואלד", "כפר יהושע", "כפר יחזקאל", "כפר כנא", "כפר מצר", "כפר קיש", "כפר תבור", "כפר תקווה", "מגדל העמק", "מגן שאול", "מוקיבלה", "מזרע", "מנשית זבדה", "מרחביה מושב", "מרחביה קיבוץ", "מרכז חבר", "משהד", "מתחם סקי גלבוע", "נאעורה", "נהלל", "נוף הגליל", "נופית", "נורית", "נין", "נצרת", "סואעד חמירה", "סולם", "סנדלה", "עדי", "עילוט", "עין דור", "עין מאהל", "עפולה", "ציפורי", "קבוצת גבע", "קריית טבעון - בית זייד", "קריית טבעון-בית זייד", "ראס עלי", "ריינה", "רם און", "רמת דוד", "רמת ישי", "רמת צבי", "שדה יעקב", "שדמות דבורה", "שיבלי אום אלג'נם", "שמשית", "שער העמקים", "שריד", "תחנת רכבת כפר ברוך", "תל עדשים", "תמרת"],
    "השפלה": ["אזור תעשייה גדרה", "אזור תעשייה נשר - רמלה", "אחיסמך", "אחיעזר", "אירוס", "באר יעקב", "בית דגן", "בית חנן", "בית חשמונאי", "בית עובד", "בית עוזיאל", "בן שמן", "גאליה", "גזר", "גיבתון", "גינתון", "גן שורק", "גן שלמה", "גנות", "גני הדר", "גני יוחנן", "זיתן", "חולדה", "חמד", "יגל", "יד רמב''ם", "יסודות", "יציץ", "ישרש", "כפר ביל''ו", "כפר בן נון", "כפר חב''ד", "כפר נוער בן שמן", "כפר שמואל", "כרמי יוסף", "לוד", "מזכרת בתיה", "מצליח", "משמר איילון", "משמר דוד", "משמר השבעה", "נטעים", "ניר צבי", "נס ציונה", "נען", "נצר חזני", "נצר סרני", "סתריה", "עזריה", "עיינות", "פארק תעשיות פלמחים", "פדיה", "פתחיה", "צפריה", "קריית עקרון", "ראשון לציון - מזרח", "ראשון לציון - מערב", "רחובות", "רמות מאיר", "רמלה", "תעשיון צריפין"],
    ...
    "לכיש": ["אביגדור", "אבן שמואל", "אורות", "אזור תעשייה באר טוביה", "אזור תעשייה כנות", "אזור תעשייה עד הלום", "אזור תעשייה קריית גת", "אזור תעשייה רבדים", "אזור תעשייה תימורים", "אחווה", "אחוזם", "איתן", "אל עזי", "אלומה", "אמונים", "אשדוד - א", "אשדוד - אזור תעשייה צפוני ונ", "אשדוד - איזור תעשייה צפוני", "אשדוד - ג", "אשדוד - ח", "אשדוד - יא", "אשדוד -יא", "אשדוד סיטי", "באר טוביה", "ביצרון", "בית אלעזרי", "בית גמליאל", "בית חלקיה", "בית עזרא", "בן זכאי", "בני דרום", "בני עי''ש", "בני ראם", "בניה", "גבעת ברנר", "גבעת וושינגטון", "גבעתי", "גדרה", "גן הדרום", "גן יבנה", "גני טל", "גת", "ד", "ורדון", "זבדיאל", "זוהר", "זרחיה", "חפץ חיים", "חצב", "חצור", "טו", "יב", "יבנה", "יד בנימין", "יד נתן", "ינון", "כנות", "כפר אביב", "כפר אחים", "כפר הנגיד", "כפר הרי''ף וצומת ראם", "כפר ורבורג", "כפר מרדכי", "כרם ביבנה", "לכיש", "מישר", "מנוחה", "מעון צופיה", "מרינה", "מרכז שפירא", "משגב דב", "משואות יצחק", "מתחם בני דרום", "נגבה", "נהורה", "נוגה", "נווה מבטח", "נועם", "נחלה", "ניר בנים", "ניר גלים", "ניר ח''ן", "סגולה", "עוזה", "עוצם", "עזר", "עזריקם", "עין צורים", "ערוגות", "עשרת", "פארק תעשייה ראם", "פלמחים", "קבוצת יבנה", "קדמה", "קדרון", "קוממיות", "קריית גת", "קריית מלאכי", "רבדים", "רווחה", "שדה דוד", "שדה יואב", "שדה משה", "שדה עוזיהו", "שדמה", "שחר", "שלווה", "שפיר", "שתולים", "תחנת רכבת קריית מלאכי - יואב", "תימורים", "תלמי יחיאל", "תלמים"],
    "מנשה": ["אביאל", "אור עקיבא", "אזור תעשייה יקנעם עילית", "אזור תעשייה מבוא כרמל", "אזור תעשייה קיסריה", "אלוני יצחק", "בי'ס כרמים בנימינה", "בית חנניה", "בנימינה", "ברקאי", "ג'סר א-זרקא", "גבעת עדה", "גן השומרון", "גן שמואל", "זכרון יעקב", "חדרה - מזרח", "חדרה - מערב", "חדרה - מרכז", "חדרה - נווה חיים", "כפר גליקסון", "כפר פינס", "להבות חביבה", "מאור", "מעגן מיכאל", "מעיין צבי", "משמרות", "מתחם שביל התפוזים", "נמל קיסריה", "עין עירון", "עין שמר", "עמיקם", "פרדס חנה כרכור", "קיסריה", "שדה יצחק", "שדות ים", "שער מנשה", "תחנת רכבת כפר יהושוע", "תלמי אלעזר"],
    "מערב הנגב": ["אופקים", "אורים", "אזור תעשייה נ.ע.מ", "אשבול", "אשל הנשיא", "בטחה", "בית הגדי", "ברור חיל", "ברוש", "גבולות", "גילת", "דורות", "זרועה", "יושיביה", "מבועים", "מסלול", "ניר משה", "ניר עקיבא", "נתיבות", "פדויים", "פטיש", "פעמי תש''ז", "צאלים", "קלחים", "קריית חינוך מרחבים", "רוחמה", "רנן", "שבי דרום", "שדה צבי", "שיבולים", "שרשרת", "תאשור", "תדהר", "תלמי ביל''ו", "תפרח"],
    "מערב לכיש": ["אזור תעשייה הדרומי אשקלון", "אזור תעשייה צפוני אשקלון", "אשקלון", "אשקלון - דרום", "אשקלון - צפון", "באר גנים", "בית שקמה", "ברכיה", "בת הדר", "גיאה", "הודיה", "חלץ", "כוכב מיכאל", "כפר סילבר", "מבקיעים", "משען", "ניצן", "ניצנים", "ניר ישראל", "תלמי יפה"],
    "מרכז הגליל": ["אבטליון", "אזור תעשייה טמרה", "אעבלין", "אשבל", "אשחר", "בועיינה-נוג'ידאת", "ביר אלמכסור", "בית סוהר צלמון", "בית רימון", "דיר חנא", "דמיידה", "הררית יחד", "חוסנייה", "חזון", "חנתון", "טורעאן", "טמרה", "טפחות", "יובלים", "יודפת", "יעד", "כאבול", "כאוכב אבו אלהיג'א", "כלנית", "כפר חנניה", "כפר מנדא", "לוטם וחמדון", "מורן", "מורשת", "מנוף", "מסד", "מע'אר", "מעלה צביה", "מצפה אבי''ב", "מצפה נטופה", "מרכז אזורי משגב", "סכנין", "סלמה", "עילבון", "עצמון - שגב", "עראבה", "ערב אל נעים", "ערב אל-נעים", "קורנית", "ראס אל-עין", "רומת אל הייב", "רקפת", "שורשים", "שכניה", "שעב", "שפרעם"],
    "מרכז הנגב": ["אום בטין", "אום בטין והפזורה", "אזור תעשייה עידן הנגב", "אל סייד", "אל-סייד והפזורה", "אשכולות", "אתר דודאים", "באר שבע - דרום", "באר שבע - מזרח", "באר שבע - מערב", "באר שבע - צפון", "בית קמה", "גבעות בר", "דביר", "חורה", "חצרים", "כרמים", "כרמית", "להב", "להבים", "לקיה", "לקיה והפזורה", "מיתר", "משמר הנגב", "נבטים", "סנסנה", "עומר", "רהט", "רהט והפזורה", "שגב שלום", "שגב שלום והפזורה", "שובל", "תארבין", "תל שבע"],
  ...
  const handleCitySearchChange = (val: string, source: 'desktop' | 'mobile') => {
    ...
    if (val.trim().length > 0) {
      ...
      const filtered = allCities.filter(c => c.includes(val)).slice(0, 10);
