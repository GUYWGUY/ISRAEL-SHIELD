...
const regionToCities: { [key: string]: string[] } = {
    ...
    "נגב": ["'ביר הדאג", "אבו קרינאת", "אבו קרינאת והפזורה", "אבו תלול", "אבו-תלול והפזורה", "אום בטין", "אום בטין והפזורה", "אופקים", "אורים", "אזור תעשייה דימונה", "אזור תעשייה נ.ע.מ", "אזור תעשייה עידן הנגב", "אזור תעשייה רותם", "אל סייד", "אל פורעה", "אל-סייד והפזורה", "אשבול", "אשכולות", "אשל הנשיא", "אשלים", "אתר דודאים", "באר מילכה", "באר שבע - דרום", "באר שבע - מזרח", "באר שבע - מערב", "באר שבע - צפון", "בטחה", "ביר הדאג'", "בית הגדי", "בית קמה", "ברור חיל", "ברוש", "גבולות", "גבעות בר", "גילת", "דביר", "דורות", "דימונה", "ואדי אל נעם דרום", "זרועה", "חורה", "חירן", "חצרים", "טללים", "יושיביה", "ירוחם", "כמהין", "כסייפה", "כסייפה והפזורה", "כפר הנוקדים", "כרמים", "כרמית", "להב", "להבים", "לקיה", "לקיה והפזורה", "מבועים", "מדרשת בן גוריון", "מיתר", "מסלול", "מצפה רמון", "מרחב עם", "מרעית", "משאבי שדה", "משמר הנגב", "נבטים", "ניצנה", "ניר משה", "ניר עקיבא", "נתיבות", "סנסנה", "סעווה", "עומר", "עזוז", "ערד", "ערערה בנגב", "פדויים", "פטיש", "פעמי תש''ז", "צאלים", "קדש ברנע", "קלחים", "קסר א-סר", "קריית חינוך מרחבים", "רביבים", "רהט", "רהט והפזורה", "רוחמה", "רנן", "רתמים", "שאנטי במדבר", "שבי דרום", "שגב שלום", "שגב שלום והפזורה", "שדה בוקר", "שדה צבי", "שובל", "שיבולים", "שרשרת", "תארבין", "תאשור", "תדהר", "תל ערד", "תל שבע", "תלמי ביל''ו", "תפרח"],
    ...
    "שומרון": ["אביתר", "אבני חפץ", "אזור תעשייה אריאל", "אזור תעשייה בראון", "אזור תעשייה ברקן", "אזור תעשייה שחק", "אזור תעשייה שער בנימין", "אחיה", "איתמר", "אלון מורה", "אעירה השחר", "אריאל", "בית אל", "בית אריה", "בית חורון", "ברוכין", "ברקן", "גבע בנימין", "גבעת אסף", "גבעת הראל", "גבעת הרואה", "גבעת פורת יוסף", "גופנה", "דולב", "דורות עילית", "החווה של זוהר", "הר ברכה", "חוות אביה", "חוות אביחי", "חוות אל נווה", "חוות אלחי", "חוות בניהו", "חוות גלעד", "חוות חנינא", "חוות יאיר", "חוות ינון", "חוות מגדלים", "חוות מגנזי", "חוות מלכיאל", "חוות מעלה אהוביה", "חוות מרום שמואל", "חוות נווה צוף", "חוות נוף אב'י", "חוות נחל שילה", "חוות נחלת צבי", "חוות עולם חסד", "חוות צרידה", "חוות ראש תאנה", "חוות שדה", "חוות שוביאל", "חוות שחרית", "חומש", "חרמש", "חרמש דרום", "חרשה", "טלמון", "יבוא דודי", "יצהר", "יקיר", "כוכב השחר", "כוכב יעקב", "כפר תפוח", "כרם רעים", "מבוא דותן", "מגדלים", "מגרון", "מכינת אלישע", "מלאכי השלום", "מעלה לבונה", "מעלה מכמש", "מצפה דני", "נווה ארז", "נווה צוף", "נופי נחמיה", "נופים", "נחליאל", "נילי", "נעלה", "נריה", "עדי עד", "עופרים", "עטרת", "עלי", "עלי זהב - לשם", "עמיחי", "עמנואל", "ענב", "עפרה", "פדואל", "פסגות", "קדומים", "קידה", "קריית נטפים", "קרני שומרון", "רבבה", "רחלים", "רימונים", "רמת מגרון", "שבות רחל", "שבי שומרון", "שדה אפרים", "שילה", "תל ציון"],
    "יהודה": ["אביגיל", "אדורה", "אדורים", "אזור תעשייה מישור אדומים", "אזור תעשייה מיתרים", "איבי הנחל", "אלון", "אלון שבות", "אליאב", "אלעזר", "אפקה", "אפרת", "אשתמוע", "בית הברכה", "בית חג'י", "בית יתיר", "ביתר עילית", "בני אדם", "בני דקלים", "בר כוכבא", "בת עין", "גבעות", "הגבעה הצהובה", "היישוב היהודי חברון", "הר גילה", "הר עמשא", "חוות ארץ האיילים", "חוות אשכולות", "חוות דרומא", "חוות הרועה העברי", "חוות טואמין", "חוות טליה", "חוות יויו", "חוות מדבר חבר", "חוות מור ואברהם", "חוות מלאכי אברהם", "חוות מקנה יהודה", "חוות נחלת אבות", "חוות עדן", "חוות צאן קדר", "חוות קשואלה", "חוות תלם צפון", "טנא עומרים", "כפר אדומים", "כפר אלדד", "כפר עציון", "כרמי צור", "כרמי קטיף ואמציה", "כרמל", "מגדל עוז", "מיצד", "מעון", "מעלה אדומים", "מעלה חבר", "מעלה עמוס", "מעלה רחבעם", "מצפה זי'ו", "מצפה חגית", "מצפה יאיר", "מצפה יריחו", "נגוהות", "נווה דניאל", "נופי פרת", "נוקדים", "נטע", "סוסיא", "סוסיא הקדומה", "עוז וגאון", "עלמון", "עשהאל", "עתניאל", "פארק תעשיות מגדל עוז", "פני קדם", "צומת הגוש", "קדר", "קדר דרום", "קרית ארבע", "ראש צורים", "שדה בועז", "שדה בר", "שומריה", "שמעה", "שני ליבנה", "שקף", "תלם", "תקוע", "תקוע ד' וה'"],
