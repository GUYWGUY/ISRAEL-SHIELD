...
export default function App() {
  ...
  const regionToCities: { [key: string]: string[] } = {
    ...
    "בקעת הירדן": ["ארגמן", "אש קודש", "בית חגלה", "בקעות", "בתרונות", "גיתית", "גלגל", "החווה של אורי כהן", "החווה של יאיא", "החווה של מנחם", "החווה של עשהאל", "חוות גנות", "חוות הרשאש", "חוות יד השומר", "חוות עמיאל", "חוות פריאל", "חמדת", "חמרה", "ייט''ב", "יפית", "מבואות יריחו", "מחולה", "מכורה", "מעלה אפרים", "מצפור פצאל", "משואה", "משכיות", "נעמה", "נערן", "נתיב הגדוד", "עינות קדם", "פצאל", "צומת אלמוג", "קדם ערבה", "רועי", "רותם", "שדמות מחולה", "שלומציון", "תומר"],
    "גולן": ["אבני איתן", "אודם", "אורטל", "אזור תעשייה בני יהודה", "אזור תעשייה צמח", "אל רום", "אלוני הבשן", "אלי עד", "אלמגור", "אניעם", "אפיק", "אשדות יעקב", "בוקעתא", "בני יהודה וגבעת יואב", "גשור", "האון", "חד נס", "חמת גדר", "חספין", "יונתן", "כנף", "כפר חרוב", "מבוא חמה", "מג'דל שמס", "מיצר", "מסדה", "מסעדה", "מעגן", "מעלה גמלא", "מרום גולן", "נאות גולן", "נוב", "נווה אטי''ב", "נטור", "נמרוד", "עין גב", "עין זיוון", "עין קנייא", "צמח", "קדמת צבי", "קלע אלון", "קצרין", "קצרין - אזור תעשייה", "קשת", "רמות", "רמת טראמפ", "רמת מגשימים", "שעל", "שער הגולן", "תל קציר"],
    "גליל מערבי": ["אדמית", "איזור תעשייה מילואות צפון", "אילון", "בית העלמין החדש נהריה", "בן עמי", "בצת", "גורן", "גורנות הגליל", "געתון", "גשר הזיו", "הילה", "חוף אכזיב", "חוף בצת", "חניתה", "יחיעם", "יערה", "כברי", "לימן", "מזרעה", "מנות", "מצובה", "נהריה", "נווה זיו", "סער", "עבדון", "עברון", "עין יעקב", "עכו", "ערב אל עראמשה", "ראש הנקרה", "שלומי"],
    "גליל עליון": ["אבו סנאן", "אביבים", "אבירים", "אבן מנחם", "אור הגנוז", "אזור תעשייה חצור הגלילית", "אזור תעשייה כרמיאל", "אזור תעשייה צ.ח.ר", "אזור תעשייה רמת דלתון", "אזור תעשייה שער נעמן", "אחיהוד", "איילת השחר", "אליפלט", "אלקוש", "אמירים", "אמנון", "אפק", "אשרת", "בוסתן הגליל", "ביריה", "בית ג'אן", "בית הלל", "בית העלמין החדש עכו", "בית העמק", "בית ספר שדה מירון", "בענה", "בר יוחאי", "ברעם", "ג'דידה מכר", "ג'וליס", "ג'ש - גוש חלב", "גדות", "גונן", "גיתה", "דוב''ב", "דיר אל-אסד", "דישון", "דלתון", "דפנה", "הגושרים", "הר חלוץ", "הר-חלוץ", "זרעית", "חולתה", "חוסן", "חורפיש", "חמדת ימים", "חצור הגלילית", "חרשים", "טובא זנגריה", "טל - אל", "טל-אל", "ינוח ג'ת", "ינוח-ג'ת", "יסוד המעלה", "יסעור", "יפתח", "יראון", "ירכא", "כורזים ורד הגליל", "כחל", "כישור", "כליל", "כמון - כמאנה מזרחית", "כסרא סמיע", "כפר בלום", "כפר גלעדי", "כפר הנשיא", "כפר ורדים", "כפר יאסיף", "כפר יובל", "כפר מסריק", "כפר סאלד", "כפר שמאי", "כרכום", "כרם בן זמרה", "כרמיאל", "לב החולה", "לבון", "להבות הבשן", "לוחמי הגטאות", "לפידות", "מג'דל כרום", "מגדל תפן", "מחניים", "מטולה", "מירון", "מכמנים - כמאנה מערבית", "מלכיה", "מנחת מחניים", "מנרה", "מעונה", "מעיין ברוך", "מעיליא", "מעלות תרשיחא", "מרגליות", "מרכז אזורי מבואות חרמון", "מרכז אזורי מרום גליל", "מרכז אזורי רמת כורזים", "משגב עם", "משמר הירדן", "מתת", "נאות מרדכי", "נחף", "נטועה", "נס עמים", "נתיב השיירה", "סאג'ור", "סאסא", "ספסופה - כפר חושן", "ע'ג'ר", "עין אל אסד", "עין המפרץ", "עכו - אזור תעשייה", "עכו - רמות ים", "עלמה", "עמוקה", "עמיעד", "עמיר", "עמקה", "פלך", "פסוטה", "פקיעין", "פקיעין החדשה", "פרוד", "צבעון", "צוריאל", "צורית גילון", "צפת - נוף כנרת", "צפת - עיר", "צפת - עכברה", "קדיתא", "קדרים", "קיבוץ דן", "קריית שמונה", "ראמה", "ראש פינה", "רגבה", "ריחאנייה", "רמות נפתלי", "שאר ישוב", "שבי ציון", "שדה אליעזר", "שדה נחמיה", "שומרה", "שזור", "שייח' דנון", "שמיר", "שמרת", "שניר", "שפר", "שתולה", "תובל", "תל חי"],
    "גליל תחתון": ["אבטליון", "אזור תעשייה בר-לב", "אזור תעשייה טמרה", "אזור תעשייה קדמת גליל", "אזור תעשייה תרדיון", "אלומות", "אעבלין", "אפיקים", "ארבל", "אשבל", "אשחר", "אתר ההנצחה גולני", "בועיינה-נוג'ידאת", "ביר אלמכסור", "בית זרע", "בית ירח", "בית סוהר צלמון", "בית רימון", "גבעת אבני", "גינוסר", "דגניה א", "דגניה ב", "דיר חנא", "דמיידה", "הודיות", "הזורעים", "הררית יחד", "ואדי אל חמאם", "חוסנייה", "חוקוק", "חזון", "חנתון", "טבריה", "טורעאן", "טמרה", "טפחות", "יבנאל", "יובלים", "יודפת", "יעד", "כאבול", "כאוכב אבו אלהיג'א", "כינרת מושבה", "כינרת קבוצה", "כלנית", "כפר זיתים", "כפר חיטים", "כפר חנניה", "כפר כמא", "כפר מנדא", "כפר נהר הירדן", "לביא", "לבנים", "לוטם וחמדון", "מגדל", "מורן", "מורשת", "מנוף", "מסד", "מע'אר", "מעלה צביה", "מצפה", "מצפה אבי''ב", "מצפה נטופה", "מרכז אזורי משגב", "נבי שועייב", "סכנין", "סלמה", "עילבון", "עצמון - שגב", "עראבה", "ערב אל נעים", "ערב אל-נעים", "פוריה כפר עבודה", "פוריה נווה עובד", "פוריה עילית", "קורנית", "ראס אל-עין", "רביד", "רומת אל הייב", "רקפת", "שדה אילן", "שורשים", "שכניה", "שעב", "שפרעם", "שרונה"],
    "דן": ["אור יהודה", "אזור", "בחלק מהאזורים בארץ", "בני ברק", "בת ים", "בת-ים", "גבעת השלושה", "גבעת שמואל", "גבעתיים", "גני תקווה", "גת רימון", "הרצליה - מערב", "הרצליה - מרכז וגליל ים", "חולון", "יהוד מונוסון", "יהוד-מונוסון", "כפר סירקין", "כפר שמריהו", "מגשימים", "מעש", "מקווה ישראל", "מתחם גלילות", "מתחם פי גלילות", "סביון", "פארק אריאל שרון", "פתח תקווה", "קריית אונו", "רמת גן - מזרח", "רמת גן - מערב", "רמת השרון", "תל אביב - דרום העיר ויפו", "תל אביב - מזרח", "תל אביב - מרכז העיר", "תל אביב - עבר הירקון"],
    "הכרמל": ["בית אורן", "בית סוהר קישון", "בית צבי", "בת שלמה", "גבע כרמל", "גבעת וולפסון", "דלית אל כרמל", "הבונים", "כרם מהר''ל", "מאיר שפיה", "מגדים", "מרכז מיר''ב", "נווה ים", "עופר", "עין איילה", "עין הוד", "עין חוד", "עין כרמל", "עספיא", "עתלית", "פוריידיס", "צרופה"],
    "המפרץ": ["אושה", "אזור תעשייה ניר עציון", "אזור תעשייה קריית ביאליק", "איבטין", "בית עלמין תל רגב", "החותרים", "חיפה - בת גלים ק.אליעזר", "חיפה - כרמל", "חיפה - מערב", "חיפה - מפרץ", "חיפה - נווה שאנן ורמות כרמל", "חיפה - קריית חיים ושמואל", "חיפה-מפרץ", "טירת כרמל", "יגור", "כפר ביאליק", "כפר גלים", "כפר המכבי", "כפר חסידים", "ניר עציון", "נשר", "קריית אתא", "קריית ביאליק", "קריית ים", "קריית מוצקין", "רכסים", "רמת יוחנן"],
    "העמקים": ["אורנים", "אזור תעשייה אלון התבור", "אזור תעשייה מבואות הגלבוע", "אזור תעשייה ציפורית", "אחוזת ברק", "אילניה", "אכסאל", "אלון הגליל", "אלוני אבא", "אלונים", "בית אלפא וחפציבה", "בית השיטה", "בית יוסף", "בית לחם הגלילית", "בית קשת", "בית שאן", "בית שערים", "בלפוריה", "בסמת טבעון", "גבעת אלה", "גבת", "גדעונה", "גזית", "גן נר", "גני חוגה", "גניגר", "גשר", "דבוריה", "דברת", "דחי", "הושעיה", "היוגב", "הסוללים", "הרדוף", "זרזיר", "חג'אג'רה", "חמדיה", "טייבה בגלבוע", "טירת צבי", "טמרה בגלבוע", "יזרעאל", "יפיע", "יפעת", "ירדנה", "ישובי אומן", "ישובי יעל", "כדורי", "כעביה טבאש", "כפר ברוך", "כפר גדעון", "כפר גמילה מלכישוע", "כפר החורש", "כפר ח'וואלד", "כפר יהושע", "כפר יחזקאל", "כפר כנא", "כפר מצר", "כפר קיש", "כפר רופין", "כפר תבור", "כפר תקווה", "מגדל העמק", "מגן שאול", "מולדת", "מוקיבלה", "מזרע", "מירב", "מנחמיה", "מנשית זבדה", "מסילות", "מעוז חיים", "מעלה גלבוע", "מרחביה מושב", "מרחביה קיבוץ", "מרכז חבר", "משהד", "מתחם סקי גלבוע", "נאעורה", "נהלל", "נוה איתן", "נווה אור", "נוף הגליל", "נופית", "נורית", "נין", "ניר דוד", "נצרת", "סואעד חמירה", "סולם", "סנדלה", "עדי", "עילוט", "עין דור", "עין הנצי''ב", "עין מאהל", "עפולה", "ציפורי", "קבוצת גבע", "קריית טבעון - בית זייד", "קריית טבעון-בית זייד", "ראס עלי", "רוויה", "רחוב", "ריינה", "רם און", "רמת דוד", "רמת ישי", "רמת צבי", "שדה אליהו", "שדה יעקב", "שדה נחום", "שדי תרומות", "שדמות דבורה", "שיבלי אום אלג'נם", "שמשית", "שער העמקים", "שריד", "תחנת רכבת כפר ברוך", "תל עדשים", "תל תאומים", "תמרת"],
    "השפלה": ["אבו גוש", "אבו-גוש", "אביעזר", "אדרת", "אזור תעשייה ברוש", "אזור תעשייה גדרה", "אזור תעשייה הר טוב - צרעה", "אזור תעשייה נשר - רמלה", "אחיסמך", "אחיעזר", "אירוס", "אשתאול", "באר יעקב", "בית גוברין", "בית דגן", "בית חנן", "בית חשמונאי", "בית מאיר", "בית ניר", "בית נקופה", "בית עובד", "בית עוזיאל", "בית שמש", "בן שמן", "בקוע", "בר גיורא", "גאליה", "גבעות עדן", "גבעת יערים", "גבעת ישעיהו", "גזר", "גיבתון", "גיזו", "גינתון", "גלאון", "גן שורק", "גן שלמה", "גנות", "גני הדר", "גני יוחנן", "גפן", "הר אדר", "הראל", "זיתן", "זכריה", "זנוח", "חולדה", "חמד", "טל שחר", "יגל", "יד השמונה", "יד רמב''ם", "יסודות", "יציץ", "ישעי", "ישרש", "כסלון", "כפר אוריה", "כפר ביל''ו", "כפר בן נון", "כפר הנוער קריית יערים", "כפר זוהרים", "כפר חב''ד", "כפר מנחם", "כפר נוער בן שמן", "כפר שמואל", "כרמי יוסף", "לוד", "לוזית", "לטרון", "מבוא ביתר", "מזכרת בתיה", "מחסיה", "מטע", "מיני ישראל - נחשון", "מסילת ציון", "מעלה החמישה", "מצליח", "משמר איילון", "משמר דוד", "משמר השבעה", "נווה אילן", "נווה מיכאל - רוגלית", "נווה שלום", "נחושה", "נחם", "נחשון", "נטעים", "נטף", "ניר צבי", "נס הרים", "נס ציונה", "נען", "נצר חזני", "נצר סרני", "נתיב הל''ה", "סתריה", "עגור", "עזריה", "עיינות", "עין נקובא", "עין ראפה", "פארק תעשיות פלמחים", "פדיה", "פתחיה", "צובה", "צור הדסה", "צלפון", "צפריה", "צפרירים", "צרעה", "קריית יערים", "קריית ענבים", "קריית עקרון", "ראשון לציון - מזרח", "ראשון לציון - מערב", "רחובות", "רטורנו - גבעת שמש", "רמות מאיר", "רמלה", "רמת רזיאל", "שדות מיכה", "שואבה", "שורש", "שריגים - לי-און", "תירוש", "תעוז", "תעשיון צריפין", "תרום"],
    "ואדי ערה": ["אום אל פחם", "אום אל קוטוף", "אזור תעשייה רגבים", "אל עריאן", "אליקים", "באקה אל גרבייה", "בי'ס כרמים בנימינה", "ברטעה", "ג'ת", "גבעת ניל''י", "גבעת עוז", "גלעד", "דליה", "חיננית", "חריש", "טל מנשה", "יקנעם המושבה והזורע", "יקנעם עילית", "כפר קרע", "מגל", "מדרך עוז", "מועאוויה", "מי עמי", "מייסר", "מעלה עירון", "מצפה אילן", "מצר", "משמר העמק", "עין אל סהלה", "עין אל-סהלה", "עין העמק", "עין השופט", "ערערה", "קיבוץ מגידו", "קציר", "רגבים", "ריחן", "רמות מנשה", "רמת השופט", "שקד"],
    "יהודה": ["אביגיל", "אדורה", "אדורים", "אזור תעשייה מישור אדומים", "אזור תעשייה מיתרים", "איבי הנחל", "אלון", "אלון שבות", "אליאב", "אלעזר", "אפקה", "אפרת", "אשתמוע", "בית הברכה", "בית חג'י", "בית חג'י", "בית יתיר", "ביתר עילית", "בני אדם", "בני דקלים", "בר כוכבא", "בת עין", "גבעות", "הגבעה הצהובה", "היישוב היהודי חברון", "הר גילה", "הר עמשא", "חוות ארץ האיילים", "חוות אשכולות", "חוות דרומא", "חוות הרועה העברי", "חוות טואמין", "חוות טליה", "חוות יויו", "חוות מדבר חבר", "חוות מור ואברהם", "חוות מלאכי אברהם", "חוות מקנה יהודה", "חוות נחלת אבות", "חוות עדן", "חוות צאן קדר", "חוות קשואלה", "חוות תלם צפון", "טנא עומרים", "כפר אדומים", "כפר אלדד", "כפר עציון", "כרמי צור", "כרמי קטיף ואמציה", "כרמל", "מגדל עוז", "מיצד", "מעון", "מעלה אדומים", "מעלה חבר", "מעלה עמוס", "מעלה רחבעם", "מצפה זי'ו", "מצפה זי'ו", "מצפה חגית", "מצפה יאיר", "מצפה יריחו", "נגוהות", "נווה דניאל", "נופי פרת", "נוקדים", "נטע", "סוסיא", "סוסיא הקדומה", "עוז וגאון", "עלמון", "עשהאל", "עתניאל", "פארק תעשיות מגדל עוז", "פני קדם", "צומת הגוש", "קדר", "קדר דרום", "קרית ארבע", "ראש צורים", "שדה בועז", "שדה בר", "שומריה", "שמעה", "שני ליבנה", "שקף", "תלם", "תקוע", "תקוע ד' וה", "תקוע ד' וה'"],
    "ים המלח": ["אבנת", "אלמוג", "בית הערבה", "בתי מלון ים המלח", "ורד יריחו", "חוות מנחם", "חוף קליה", "מלונות ים המלח מרכז", "מצדה", "מצוקי דרגות", "מצפה מדרג", "מצפה שלם", "מרחצאות עין גדי", "מרכז אזורי מגילות", "נאות הכיכר", "נווה זוהר", "עין בוקק", "עין גדי", "עין תמר", "קליה"],
    "ירושלים": ["אבן ספיר", "אורה", "בית זית", "גבעון החדשה", "גבעת זאב", "ירושלים - אזור תעשייה עטרות", "ירושלים - דרום", "ירושלים - כפר עקב", "ירושלים - מזרח", "ירושלים - מערב", "ירושלים - מרכז", "ירושלים - צפון", "ירושלים - צפון ואלונים", "מבשרת ציון", "מוצא עילית", "עמינדב", "פנימיית עין כרם"],
    "ירקון": ["אזור תעשייה אפק ולב הארץ", "אזור תעשייה חבל מודיעין שוהם", "איירפורט סיטי", "אלעד", "בארות יצחק", "בית נחמיה", "בית עריף", "בני עטרות", "ברקת", "גבעת כ''ח", "גמזו", "חדיד", "חשמונאים", "טירת יהודה", "כפר דניאל", "כפר האורנים", "כפר טרומן", "כפר רות", "לפיד", "מבוא חורון", "מבוא מודיעים", "מודיעין - ישפרו סנטר", "מודיעין - ליגד סנטר", "מודיעין מכבים רעות", "מודיעין עילית", "מזור", "מתתיהו", "נאות קדומים", "נוף איילון", "נופך", "נחלים", "נחשונים", "עינת", "ראש העין", "רינתיה", "שוהם", "שילת", "שעלבים"],
    "לכיש": ["אביגדור", "אבן שמואל", "אורות", "אזור תעשייה באר טוביה", "אזור תעשייה הדרומי אשקלון", "אזור תעשייה כנות", "אזור תעשייה עד הלום", "אזור תעשייה צפוני אשקלון", "אזור תעשייה קריית גת", "אזור תעשייה רבדים", "אזור תעשייה תימורים", "אחווה", "אחוזם", "איתן", "אל עזי", "אלומה", "אמונים", "אשדוד - א", "אשדוד - אזור תעשייה צפוני ונ", "אשדוד - איזור תעשייה צפוני", "אשדוד - ג", "אשדוד - ח", "אשדוד - יא", "אשדוד -יא", "אשדוד סיטי", "אשקלון", "אשקלון - דרום", "אשקלון - צפון", "באר גנים", "באר טוביה", "ביצרון", "בית אלעזרי", "בית גמליאל", "בית חלקיה", "בית עזרא", "בית שקמה", "בן זכאי", "בני דרום", "בני עי''ש", "בני ראם", "בניה", "ברכיה", "בת הדר", "גבעת ברנר", "גבעת וושינגטון", "גבעתי", "גדרה", "גיאה", "גן הדרום", "גן יבנה", "גני טל", "גת", "ד", "הודיה", "ורדון", "זבדיאל", "זוהר", "זרחיה", "חלץ", "חפץ חיים", "חצב", "חצור", "טו", "יב", "יבנה", "יד בנימין", "יד נתן", "ינון", "כוכב מיכאל", "כנות", "כפר אביב", "כפר אחים", "כפר הנגיד", "כפר הרי''ף וצומת ראם", "כפר ורבורג", "כפר מרדכי", "כפר סילבר", "כרם ביבנה", "לכיש", "מבקיעים", "מישר", "מנוחה", "מעון צופיה", "מרינה", "מרכז שפירא", "משגב דב", "משואות יצחק", "משען", "מתחם בני דרום", "נגבה", "נהורה", "נוגה", "נווה מבטח", "נועם", "נחלה", "ניצן", "ניצנים", "ניר בנים", "ניר גלים", "ניר ח''ן", "ניר ישראל", "סגולה", "עוזה", "עוצם", "עזר", "עזריקם", "עין צורים", "ערוגות", "עשרת", "פארק תעשייה ראם", "פלמחים", "קבוצת יבנה", "קדמה", "קדרון", "קוממיות", "קריית גת", "קריית מלאכי", "רבדים", "רווחה", "שדה דוד", "שדה יואב", "שדה משה", "שדה עוזיהו", "שדמה", "שחר", "שלווה", "שפיר", "שתולים", "תחנת רכבת קריית מלאכי - יואב", "תימורים", "תלמי יחיאל", "תלמי יפה", "תלמים"],
    "נגב": ["אבו קרינאת", "אבו קרינאת והפזורה", "אבו תלול", "אבו-תלול והפזורה", "אום בטין", "אום בטין והפזורה", "אופקים", "אורים", "אזור תעשייה דימונה", "אזור תעשייה נ.ע.מ", "אזור תעשייה עידן הנגב", "אזור תעשייה רותם", "אל סייד", "אל פורעה", "אל-סייד והפזורה", "אשבול", "אשכולות", "אשל הנשיא", "אשלים", "אתר דודאים", "באר מילכה", "באר שבע - דרום", "באר שבע - מזרח", "באר שבע - מערב", "באר שבע - צפון", "בטחה", "ביר הדאג", "ביר הדאג'", "בית הגדי", "בית קמה", "ברור חיל", "ברוש", "גבולות", "גבעות בר", "גילת", "דביר", "דורות", "דימונה", "ואדי אל נעם דרום", "זרועה", "חורה", "חירן", "חצרים", "טללים", "יושיביה", "ירוחם", "כמהין", "כסייפה", "כסייפה והפזורה", "כפר הנוקדים", "כרמים", "כרמית", "להב", "להבים", "לקיה", "לקיה והפזורה", "מבועים", "מדרשת בן גוריון", "מיתר", "מסלול", "מצפה רמון", "מרחב עם", "מרעית", "משאבי שדה", "משמר הנגב", "נבטים", "ניצנה", "ניר משה", "ניר עקיבא", "נתיבות", "סנסנה", "סעווה", "עומר", "עזוז", "ערד", "ערערה בנגב", "פדויים", "פטיש", "פעמי תש''ז", "צאלים", "קדש ברנע", "קלחים", "קסר א-סר", "קריית חינוך מרחבים", "רביבים", "רהט", "רהט והפזורה", "רוחמה", "רנן", "רתמים", "שאנטי במדבר", "שבי דרום", "שגב שלום", "שגב שלום והפזורה", "שדה בוקר", "שדה צבי", "שובל", "שיבולים", "שרשרת", "תארבין", "תאשור", "תדהר", "תל ערד", "תל שבע", "תלמי ביל''ו", "תפרח"],
    "עוטף עזה": ["אבשלום", "אור הנר", "איבים", "ארז", "בארי", "בני נצרים", "גבים", "גברעם", "דקל", "זיקים", "חולית", "חוף זיקים", "חניון רעים אנדרטת הנובה", "יבול", "יד מרדכי", "יכיני", "יתד", "כיסופים", "כפר מימון ותושיה", "כפר עזה", "כרם שלום", "כרמיה", "מגן", "מטווח ניר עם", "מכללת ספיר", "מפלסים", "נווה", "נחל עוז", "ניר יצחק", "ניר עוז", "ניר עם", "נירים", "נתיב העשרה", "סופה", "סעד", "עין הבשור", "עין השלושה", "עלומים", "פרי גן", "רעים", "שדה ניצן", "שדי אברהם", "שדרות", "שוקדה", "שלומית", "תלמי אליהו", "תלמי יוסף", "תקומה"],
    "ערבה": ["אליפז ומכרות תמנע", "באר אורה", "גרופית", "חצבה", "יהל", "יטבתה", "לוטן", "נאות סמדר", "נווה חריף", "סמר", "ספיר", "עידן", "עין חצבה", "עין יהב", "פארן", "צופר", "צוקים", "קטורה", "שחרות", "שיטים"],
    "שומרון": ["אביתר", "אבני חפץ", "אזור תעשייה אריאל", "אזור תעשייה בראון", "אזור תעשייה ברקן", "אזור תעשייה שחק", "אזור תעשייה שער בנימין", "אחיה", "איתמר", "אלון מורה", "אעירה השחר", "אריאל", "בית אל", "בית אריה", "בית חורון", "ברוכין", "ברקן", "גבע בנימין", "גבעת אסף", "גבעת הראל", "גבעת הרואה", "גבעת פורת יוסף", "גופנה", "דולב", "דורות עילית", "החווה של זוהר", "הר ברכה", "חוות אביה", "חוות אביחי", "חוות אל נווה", "חוות אלחי", "חוות בניהו", "חוות גלעד", "חוות חנינא", "חוות יאיר", "חוות ינון", "חוות מגדלים", "חוות מגנזי", "חוות מלכיאל", "חוות מעלה אהוביה", "חוות מרום שמואל", "חוות נווה צוף", "חוות נוף אב'י", "חוות נוף אב'י", "חוות נחל שילה", "חוות נחלת צבי", "חוות עולם חסד", "חוות צרידה", "חוות ראש תאנה", "חוות שדה", "חוות שוביאל", "חוות שחרית", "חומש", "חרמש", "חרמש דרום", "חרשה", "טלמון", "יבוא דודי", "יצהר", "יקיר", "כוכב השחר", "כוכב יעקב", "כפר תפוח", "כרם רעים", "מבוא דותן", "מגדלים", "מגרון", "מכינת אלישע", "מלאכי השלום", "מעלה לבונה", "מעלה מכמש", "מצפה דני", "נווה ארז", "נווה צוף", "נופי נחמיה", "נופים", "נחליאל", "נילי", "נעלה", "נריה", "עדי עד", "עופרים", "עטרת", "עלי", "עלי זהב - לשם", "עמיחי", "עמנואל", "ענב", "עפרה", "פדואל", "פסגות", "קדומים", "קידה", "קריית נטפים", "קרני שומרון", "רבבה", "רחלים", "רימונים", "רמת מגרון", "שבות רחל", "שבי שומרון", "שדה אפרים", "שילה", "תל ציון"],
    "שרון": ["אביאל", "אביחיל", "אבן יהודה", "אודים", "אור עקיבא", "אורנית", "אזור תעשייה טירה", "אזור תעשייה יקנעם עילית", "אזור תעשייה כפר יונה", "אזור תעשייה מבוא כרמל", "אזור תעשייה עמק חפר", "אזור תעשייה קיסריה", "אחיטוב", "אייל", "אלוני יצחק", "אליכין", "אלישיב", "אלישמע", "אלפי מנשה", "אלקנה", "אמץ", "ארסוף", "בארותיים", "בורגתה", "בחן", "בי'ס כרמים בנימינה", "בית ברל", "בית הלוי", "בית חנניה", "בית חרות", "בית יהושע", "בית ינאי", "בית יצחק - שער חפר", "בית עלמין מורשה", "ביתן אהרן", "בני דרור", "בני ציון", "בנימינה", "בצרה", "ברקאי", "בת חן", "בת חפר", "ג'לג'וליה", "ג'סר א-זרקא", "גאולי תימן", "גאולים", "גבעת חיים איחוד", "גבעת חיים מאוחד", "גבעת חן", "גבעת עדה", "גבעת שפירא", "גן השומרון", "גן חיים", "גן יאשיה", "גן שמואל", "גנות הדר", "גני עם", "געש", "הדר עם", "הוד השרון", "המעפיל", "המרכז האקדמי רופין", "העוגן", "זכרון יעקב", "זמר", "חבצלת השרון וצוקי ים", "חגור", "חגלה", "חדרה - מזרח", "חדרה - מערב", "חדרה - מרכז", "חדרה - נווה חיים", "חופית", "חורשים", "חיבת ציון", "חניאל", "חרב לאת", "חרוצים", "חרות", "טייבה", "טירה", "יד חנה", "ינוב", "יקום", "ירחיב", "ירקונה", "כוכב יאיר - צור יגאל", "כפר ברא", "כפר גליקסון", "כפר הס", "כפר הרא''ה", "כפר ויתקין", "כפר חיים", "כפר ידידיה", "כפר יונה", "כפר מונש", "כפר מל''ל", "כפר נטר", "כפר סבא", "כפר עבודה", "כפר פינס", "כפר קאסם", "להבות חביבה", "מאור", "מכון וינגייט", "מכמורת", "מסוף אורנית", "מעברות", "מעגן מיכאל", "מעיין צבי", "מרכז אזורי דרום השרון", "משמר השרון", "משמרות", "משמרת", "מתחם שביל התפוזים", "מתן", "נווה ימין", "נווה ירק", "נורדיה", "ניצני עוז", "ניר אליהו", "נירית", "נמל קיסריה", "נעורים", "נתניה - מזרח", "נתניה - מערב", "סלעית", "עדנים", "עולש", "עזריאל", "עין החורש", "עין ורד", "עין עירון", "עין שמר", "עין שריד", "עמיקם", "עץ אפרים", "פורת", "פרדס חנה כרכור", "פרדסיה", "צופים", "צופית", "צור יצחק", "צור משה", "צור נתן", "קדימה צורן", "קדימה-צורן", "קיסריה", "קלנסווה", "רמות השבים", "רמת הכובש", "רעננה", "רשפון", "שדה ורבורג", "שדה יצחק", "שדות ים", "שדי חמד", "שושנת העמקים", "שער אפרים", "שער מנשה", "שערי תקווה", "שפיים", "תחנת רכבת כפר יהושוע", "תחנת רכבת ראש העין", "תל יצחק", "תל מונד", "תלמי אלעזר", "תנובות"],
  };
