...
export default function App() {
  ...
  const getCityCoords = (cityStr: string) => {
    ...
    "אילת": ["אזור תעשייה שחורת", "אילות", "אילת", "בחר הכל"],
    "בקעת הירדן": ["אלמוג", "ארגמן", "בית הערבה", "בקעות", "בתרונות", "גיתית", "גלגל", "החווה של אורי כהן", "החווה של יאיא", "החווה של מנחם", "החווה של עשהאל", "ורד יריחו", "חוות גנות", "חוות הרשאש", "חוות יד השומר", "חוות מגדלים", "חוות מרום שמואל", "חוות פריאל", "חמדת", "חמרה", "ייט''ב", "ייט'ב", "יפית", "מחולה", "מכורה", "מעלה אפרים", "מצפור פצאל", "משואה", "משכיות", "נעמה", "נערן", "נתיב הגדוד", "עינות קדם", "פצאל", "רועי", "רותם", "שדמות מחולה", "שלומציון", "תומר"],
    "גולן": ["אבני איתן", "אודם", "אורטל", "אזור תעשייה בני יהודה", "אזור תעשייה צמח", "אל רום", "אלוני הבשן", "אלי עד", "אניעם", "אפיק", "אפיקים", "בוקעתא", "בני יהודה וגבעת יואב", "גונן", "גשור", "האון", "חמת גדר", "חספין", "יונתן", "כנף", "כפר חרוב", "כרכום", "מבוא חמה", "מג'דל שמס", "מיצר", "מסעדה", "מעגן", "מעלה גמלא", "מרום גולן", "נאות גולן", "נוב", "נווה אטי''ב", "נווה אטי'ב", "נטור", "נמרוד", "עין גב", "עין זיוון", "עין קנייא", "קדמת צבי", "קצרין", "קצרין - אזור תעשייה", "קשת", "רמות", "רמת טראמפ", "רמת מגשימים", "שעל", "שער הגולן", "תל קציר"],
    "גליל מערבי": ["אדמית", "איזור תעשייה מילואות צפון", "אילון", "בן עמי", "בצת", "גורן", "גורנות הגליל", "געתון", "גשר הזיו", "חוף אכזיב", "חוף בצת", "חניתה", "יחיעם", "יערה", "כברי", "כליל", "לימן", "מנות", "מצובה", "נהריה", "נווה זיו", "נתיב השיירה", "סער", "עבדון", "עין יעקב", "ערב אל עראמשה", "ראש הנקרה", "שבי ציון", "שלומי"],
    "גליל עליון": ["אבו סנאן", "אביבים", "אבירים", "אבן מנחם", "אור הגנוז", "אזור תעשייה בר-לב", "אזור תעשייה חצור הגלילית", "אזור תעשייה כרמיאל", "אזור תעשייה צ.ח.ר", "אזור תעשייה קריית ביאליק", "אזור תעשייה רמת דלתון", "אזור תעשייה שער נעמן", "אחיהוד", "איילת השחר", "אליפלט", "אלמגור", "אלקוש", "אמירים", "אמנון", "אשרת", "בוסתן הגליל", "ביריה", "בית ג'אן", "בית הלל", "בית העלמין החדש נהריה", "בית העלמין החדש עכו", "בית העמק", "בית ספר שדה מירון", "בענה", "בר יוחאי", "ברעם", "ג'דידה מכר", "ג'וליס", "ג'ש - גוש חלב", "גדות", "גיתה", "דוב''ב", "דוב'ב", "דיר אל-אסד", "דישון", "דלתון", "דפנה", "הגושרים", "הילה", "הר חלוץ", "הר-חלוץ", "זרעית", "חד נס", "חולתה", "חוסן", "חוקוק", "חורפיש", "חמדת ימים", "חצור הגלילית", "חרשים", "טובא זנגריה", "טל - אל", "טל-אל", "ינוח ג'ת", "ינוח-ג'ת", "יסוד המעלה", "יסעור", "יפתח", "יראון", "ירכא", "כורזים ורד הגליל", "כישור", "כמון - כמאנה מזרחית", "כסרא סמיע", "כפר בלום", "כפר גלעדי", "כפר הנשיא", "כפר ורדים", "כפר יאסיף", "כפר יובל", "כפר מסריק", "כפר סאלד", "כפר שמאי", "כרם בן זמרה", "לב החולה", "לבון", "להבות הבשן", "לוחמי הגטאות", "לפידות", "מג'דל כרום", "מגדל תפן", "מזרעה", "מחניים", "מטולה", "מירון", "מלכיה", "מנחת מחניים", "מנרה", "מעונה", "מעיין ברוך", "מעיליא", "מעלות תרשיחא", "מרגליות", "מרכז אזורי מבואות חרמון", "מרכז אזורי מרום גליל", "מרכז אזורי רמת כורזים", "משגב עם", "משמר הירדן", "מתת", "נאות מרדכי", "נחף", "נטועה", "נס עמים", "סאג'ור", "סאסא", "ספסופה - כפר חושן", "ע'ג'ר", "עברון", "עין אל אסד", "עין המפרץ", "עכו", "עכו - אזור תעשייה", "עכו - רמות ים", "עלמה", "עמוקה", "עמיעד", "עמיר", "עמקה", "פלך", "פסוטה", "פקיעין", "פקיעין החדשה", "פרוד", "צבעון", "צוריאל", "צפת - נוף כנרת", "צפת - עיר", "צפת - עכברה", "קדיתא", "קיבוץ דן", "קלע אלון", "קריית שמונה", "ראמה", "ראש פינה", "רגבה", "ריחאנייה", "רמות נפתלי", "שאר ישוב", "שדה אליעזר", "שדה נחמיה", "שומרה", "שזור", "שייח' דנון", "שמיר", "שמרת", "שניר", "שפר", "שתולה", "תובל", "תל חי"],
    "גליל תחתון": ["אבטליון", "אזור תעשייה טמרה", "אזור תעשייה קדמת גליל", "אזור תעשייה תרדיון", "אילניה", "אלומות", "אעבלין", "ארבל", "אשבל", "אשדות יעקב", "אשחר", "אתר ההנצחה גולני", "בועיינה-נוג'ידאת", "ביר אלמכסור", "בית זרע", "בית ירח", "בית סוהר צלמון", "בית רימון", "גבעת אבני", "גינוסר", "דגניה א", "דגניה ב", "דיר חנא", "דמיידה", "הודיות", "הזורעים", "הררית יחד", "ואדי אל חמאם", "חוסנייה", "חזון", "חנתון", "טבריה", "טורעאן", "טמרה", "טפחות", "יבנאל", "יובלים", "יודפת", "יעד", "כאבול", "כאוכב אבו אלהיג'א", "כחל", "כינרת מושבה", "כינרת קבוצה", "כלנית", "כפר זיתים", "כפר חיטים", "כפר חנניה", "כפר כמא", "כפר מנדא", "כפר נהר הירדן", "כרמיאל", "לביא", "לבנים", "לוטם וחמדון", "מגדל", "מורן", "מורשת", "מכמנים - כמאנה מערבית", "מנוף", "מנחמיה", "מסד", "מסדה", "מע'אר", "מעלה צביה", "מצפה", "מצפה אבי''ב", "מצפה אבי'ב", "מצפה נטופה", "מרכז אזורי משגב", "נבי שועייב", "סכנין", "סלמה", "עוזייר, רומאנה", "עילבון", "עצמון - שגב", "עראבה", "ערב אל נעים", "ערב אל-נעים", "פוריה כפר עבודה", "פוריה נווה עובד", "פוריה עילית", "צורית גילון", "צמח", "קדרים", "קורנית", "ראס אל-עין", "רביד", "רומת אל הייב", "רקפת", "שדה אילן", "שורשים", "שכניה", "שעב", "שרונה"],
    "דן": ["בית עלמין מורשה", "בני ברק", "בת ים", "בת-ים", "גבעת שמואל", "גבעתיים", "גני תקווה", "גת רימון", "הרצליה - מערב", "הרצליה - מרכז וגליל ים", "חולון", "יהוד מונוסון", "יהוד-מונוסון", "מעש", "מקווה ישראל", "מתחם גלילות", "מתחם פי גלילות", "סביון", "עינת", "פתח תקווה", "קריית אונו", "רמת גן - מזרח", "רמת גן - מערב", "רמת השרון", "תל אביב - דרום העיר ויפו", "תל אביב - מזרח", "תל אביב - מרכז העיר", "תל אביב - עבר הירקון"],
    "הכרמל": ["אזור תעשייה ניר עציון", "בית אורן", "בית צבי", "בת שלמה", "גבע כרמל", "גבעת וולפסון", "דור, נחשולים", "דלית אל כרמל", "הבונים", "כרם מהר''ל", "כרם מהר'ל", "מאיר שפיה", "מרכז מיר''ב", "מרכז מיר'ב", "נווה ים", "ניר עציון, ימין אורד", "עופר", "עין איילה", "עין הוד", "עין חוד", "עין כרמל", "עספיא", "עתלית", "צרופה"],
    "המפרץ": ["אושה", "איבטין", "אפק", "החותרים", "חיפה - בת גלים ק.אליעזר", "חיפה - כרמל", "חיפה - כרמל, הדר ועיר תחתית", "חיפה - מערב", "חיפה - מפרץ", "חיפה - נווה שאנן ורמות כרמל", "חיפה - קריית חיים ושמואל", "חיפה-מפרץ", "טירת כרמל", "יגור", "כפר ביאליק", "כפר גלים", "כפר המכבי", "כפר חסידים", "מגדים", "ניר עציון", "נשר", "קריית אתא", "קריית ביאליק", "קריית ים", "קריית מוצקין", "רכסים", "רמת יוחנן"],
    "העמקים": ["אורנים", "אזור תעשייה אלון התבור", "אזור תעשייה מבואות הגלבוע", "אזור תעשייה ציפורית", "אחוזת ברק", "אכסאל", "אלון הגליל", "אלוני אבא", "אלונים", "בית אלפא וחפציבה", "בית השיטה", "בית יוסף", "בית לחם הגלילית", "בית סוהר קישון", "בית עלמין תל רגב", "בית קשת", "בית שאן", "בית שערים", "בלפוריה", "בסמת טבעון", "גבעת אלה", "גבת", "גדעונה", "גזית", "גן נר", "גני חוגה", "גניגר", "גשר", "דבוריה", "דברת", "דחי", "הושעיה", "היוגב", "הסוללים", "הרדוף", "זרזיר", "חג'אג'רה", "חוות עמיאל", "חמדיה", "טייבה בגלבוע", "טירת צבי", "טמרה בגלבוע", "יזרעאל", "יפיע", "יפעת", "ירדנה", "ישובי אומן", "ישובי יעל", "כדורי", "כעביה טבאש", "כפר ברוך", "כפר גדעון", "כפר גמילה מלכישוע", "כפר החורש", "כפר ח'וואלד", "כפר יהושע", "כפר יחזקאל", "כפר כנא", "כפר מצר", "כפר קיש", "כפר רופין", "כפר תבור", "כפר תקווה", "מגדל העמק", "מגן שאול", "מולדת", "מוקיבלה", "מזרע", "מירב", "מנשית זבדה", "מסילות", "מעוז חיים", "מעלה גלבוע", "מרחביה מושב", "מרחביה קיבוץ", "מרכז חבר", "משהד", "מתחם סקי גלבוע", "נאעורה", "נהלל", "נוה איתן", "נווה אור", "נוף הגליל", "נופית", "נורית", "נין", "ניר דוד", "נצרת", "סואעד חמירה", "סולם", "סנדלה", "עדי", "עילוט", "עין דור", "עין הנצי''ב", "עין הנצי'ב", "עין חרוד, תל יוסף", "עין מאהל", "עפולה", "ציפורי", "קבוצת גבע", "קריית טבעון - בית זייד", "קריית טבעון-בית זייד", "ראס עלי", "רוויה", "רחוב", "ריינה", "רם און", "רמת דוד", "רמת ישי", "רמת צבי", "רשפים, שלוחות, שלפים", "שדה אליהו", "שדה יעקב", "שדה נחום", "שדי תרומות", "שדמות דבורה", "שיבלי אום אלג'נם", "שמשית", "שער העמקים", "שפרעם", "שריד", "תחנת רכבת כפר ברוך", "תחנת רכבת כפר יהושוע", "תל עדשים", "תל תאומים", "תמרת"],
    "השפלה": ["אבו גוש", "אבו-גוש", "אביעזר", "אדרת", "אור יהודה", "אזור", "אזור תעשייה ברוש", "אזור תעשייה הר טוב - צרעה", "אזור תעשייה נשר - רמלה", "אחיסמך", "אחיעזר", "אירוס", "אשתאול", "באר יעקב", "בית אלעזרי", "בית גוברין", "בית דגן", "בית חנן", "בית חשמונאי", "בית מאיר", "בית ניר", "בית נקופה", "בית עובד", "בית עוזיאל", "בית שמש", "ביתר עילית", "בן שמן", "בקוע", "בר גיורא", "גבעות עדן", "גבעת ברנר", "גבעת יערים", "גבעת ישעיהו", "גזר", "גיבתון", "גיזו", "גינתון", "גלאון", "גמזו", "גן שורק", "גן שלמה", "גנות", "גני הדר", "גני יוחנן", "גפן", "הר אדר", "הראל", "זיתן", "זכריה", "זנוח", "חדיד", "חולדה", "חמד", "טל שחר", "יגל", "יד השמונה", "יד רמב''ם", "יד רמב'ם", "יסודות", "יציץ", "ישעי", "ישרש", "כסלון", "כפר אוריה", "כפר ביל''ו", "כפר ביל'ו", "כפר בן נון", "כפר דניאל", "כפר הנוער קריית יערים", "כפר זוהרים", "כפר חב''ד", "כפר חב'ד", "כפר נוער בן שמן", "כפר שמואל", "כרמי יוסף", "לוד", "לוזית", "לטרון", "מבוא ביתר", "מבוא חורון", "מבשרת ציון", "מודיעין - ישפרו סנטר", "מזכרת בתיה", "מחסיה", "מטע", "מיני ישראל - נחשון", "מסילת ציון", "מעלה החמישה", "מצליח", "משמר איילון", "משמר דוד", "משמר השבעה", "נווה אילן", "נווה מיכאל - רוגלית", "נווה שלום", "נוף איילון, שעלבים", "נחושה", "נחם", "נחשון", "נטעים", "נטף", "ניר צבי", "נס הרים", "נס ציונה", "נען", "נצר חזני", "נצר סרני", "נתיב הל''ה", "נתיב הל'ה", "סתריה", "עגור", "עזריה", "עיינות", "עין נקובא", "עין ראפה", "פארק אריאל שרון", "פארק תעשיות פלמחים", "פדיה", "פלמחים", "פתחיה", "צובה", "צור הדסה", "צלפון", "צפריה", "צפרירים", "צרעה", "קריית יערים", "קריית ענבים", "קריית עקרון", "ראשון לציון - מזרח", "ראשון לציון - מערב", "רחובות", "רטורנו - גבעת שמש", "רמות מאיר", "רמלה", "רמת רזיאל", "שדות מיכה", "שואבה", "שורש", "שריגים - לי-און", "תירוש", "תעוז", "תעשיון צריפין", "תרום"],
    "ואדי ערה": ["אום אל פחם", "אום אל קוטוף", "אזור תעשייה יקנעם עילית", "אזור תעשייה מבוא כרמל", "אזור תעשייה רגבים", "אזור תעשייה שחק", "אל עריאן", "אליקים", "באקה אל גרבייה", "ברטעה", "ג'ת", "גבעת ניל''י", "גבעת ניל'י", "גבעת עוז", "גלעד", "דליה", "חוות אביה", "חיננית", "חריש", "טל מנשה", "יקנעם עילית", "מדרך עוז", "מועאוויה", "מי עמי", "מייסר", "מעלה עירון", "מצפה אילן", "מצר", "משמר העמק", "עין אל סהלה", "עין אל-סהלה", "עין העמק", "עין השופט", "עמיקם", "ערערה", "קיבוץ מגידו", "קציר", "רגבים", "ריחן", "רמות מנשה", "רמת השופט", "שקד"],
    "יהודה": ["אביגיל", "אדורה", "אדורים", "אזור תעשייה מישור אדומים", "אזור תעשייה מיתרים", "איבי הנחל", "אלון", "אלון שבות", "אליאב", "אלעזר", "אפקה", "אפרת", "אשתמוע", "בית הברכה", "בית חג'י", "בית חג'י", "בית יתיר", "בני דקלים", "בר כוכבא", "בת עין", "גבעות", "הגבעה הצהובה", "היישוב היהודי חברון", "הר גילה", "הר עמשא", "חוות ארץ האיילים", "חוות אשכולות", "חוות דרומא", "חוות הרועה העברי", "חוות טואמין", "חוות טליה", "חוות יויו", "חוות מדבר חבר", "חוות מור ואברהם", "חוות מלאכי אברהם", "חוות מנחם", "חוות מקנה יהודה", "חוות נחלת אבות", "חוות עדן", "חוות צאן קדר", "חוות קשואלה", "חוות תלם צפון", "חירן", "טנא עומרים", "ירושלים - דרום", "כפר אדומים", "כפר אלדד", "כפר עציון", "כרמי צור", "כרמי קטיף ואמציה", "כרמל", "מגדל עוז", "מיצד", "מעון", "מעלה אדומים", "מעלה חבר", "מעלה עמוס", "מעלה רחבעם", "מצפה זי'ו", "מצפה זי'ו", "מצפה יאיר", "מצפה יריחו", "מצפה מדרג", "נגוהות", "נווה דניאל", "נופי פרת", "נוקדים", "נטע", "סוסיא", "סוסיא הקדומה", "עוז וגאון", "עלמון", "עשהאל", "עתניאל", "פארק תעשיות מגדל עוז", "פני קדם", "צומת הגוש", "קדר", "קדר דרום", "קרית ארבע", "ראש צורים", "שדה בועז", "שדה בר", "שמעה", "שני ליבנה", "שקף", "תלם", "תקוע", "תקוע ד' וה", "תקוע ד' וה'"],
    "ים המלח": ["אבנת", "בית חגלה", "בתי מלון ים המלח", "חוף קליה", "כפר הנוקדים", "מלונות ים המלח מרכז", "מצדה", "מצוקי דרגות", "מצפה שלם", "מרחצאות עין גדי", "מרכז אזורי מגילות", "נווה זוהר", "עין בוקק", "עין גדי", "צומת אלמוג", "קדם ערבה", "קליה"],
    "ירושלים": ["אבן ספיר", "אורה", "בית זית", "בית חורון", "גבעון החדשה", "גבעת זאב", "ירושלים - מזרח", "ירושלים - מערב", "ירושלים - מרכז", "ירושלים - צפון", "ירושלים - צפון ואלונים", "מוצא עילית", "עמינדב", "פנימיית עין כרם"],
    "ירקון": ["אזור תעשייה חבל מודיעין שוהם", "איירפורט סיטי", "אלעד", "בארות יצחק", "בית נחמיה", "בית עריף", "בני עטרות", "ברקת", "גבעת השלושה", "גבעת כ''ח", "גבעת כ'ח", "חשמונאים", "טירת יהודה", "כפר האורנים", "כפר טרומן", "כפר סירקין", "כפר רות", "לפיד", "מבוא מודיעים", "מגשימים", "מודיעין - ליגד סנטר", "מודיעין מכבים רעות", "מודיעין עילית", "מזור", "מתתיהו", "נאות קדומים", "נוף איילון", "נופך", "נחלים", "נחשונים", "ראש העין", "רינתיה", "שוהם", "שילת", "שעלבים"],
    "לכיש": ["אביגדור", "אבן שמואל", "אורות", "אזור תעשייה באר טוביה", "אזור תעשייה גדרה", "אזור תעשייה כנות", "אזור תעשייה עד הלום", "אזור תעשייה צפוני אשקלון", "אזור תעשייה קריית גת", "אזור תעשייה רבדים", "אזור תעשייה תימורים", "אחווה", "אחוזם", "איתן", "אל עזי", "אלומה", "אמונים", "אשדוד - א", "אשדוד - א,ב,ד,ה", "אשדוד - אזור תעשייה צפוני ונ", "אשדוד - איזור תעשייה צפוני", "אשדוד - ג", "אשדוד - ג,ו,ז", "אשדוד - ח", "אשדוד - ח,ט,י,יג,יד,טז", "אשדוד - יא", "אשדוד -יא", "אשדוד -יא,יב,טו,יז,מרינה,סיטי", "אשדוד סיטי", "אשקלון", "אשקלון - דרום", "אשקלון - צפון", "באר גנים", "באר טוביה", "ביצרון", "בית גמליאל", "בית חלקיה", "בית עזרא", "בית שקמה", "בן זכאי", "בני דרום", "בני עי''ש", "בני עי'ש", "בני ראם", "בניה", "ברור חיל", "ברכיה", "בת הדר", "גאליה", "גבעת וושינגטון", "גבעתי", "גברעם", "גדרה", "גיאה", "גן הדרום", "גן יבנה", "גני טל", "גת", "ד", "הודיה", "ורדון", "זבדיאל", "זוהר", "זרחיה", "חלץ", "חפץ חיים", "חצב", "חצור", "טו", "יב", "יבנה", "יד בנימין", "יד נתן", "ינון", "כוכב מיכאל", "כנות", "כפר אביב", "כפר אחים", "כפר הנגיד", "כפר הרי''ף וצומת ראם", "כפר הרי'ף וצומת ראם", "כפר ורבורג", "כפר מנחם", "כפר מרדכי", "כפר סילבר", "כרם ביבנה", "לכיש", "מבקיעים", "מישר", "מנוחה", "מעון צופיה", "מרינה", "מרכז שפירא", "משגב דב", "משואות יצחק", "משען", "מתחם בני דרום", "נגבה", "נהורה", "נוגה", "נווה מבטח", "נועם", "נחלה", "ניצן", "ניצנים", "ניר בנים", "ניר גלים", "ניר ח''ן", "ניר ח'ן", "ניר ישראל", "סגולה", "עוזה", "עוצם", "עזר", "עזריקם", "עין צורים", "ערוגות", "עשרת", "פארק תעשייה ראם", "קבוצת יבנה", "קדמה", "קדרון", "קוממיות", "קריית גת", "קריית גת, כרמי גת", "קריית מלאכי", "רבדים", "רווחה", "שדה דוד", "שדה יואב", "שדה משה", "שדה עוזיהו", "שדמה", "שחר", "שלווה", "שפיר", "שתולים", "תחנת רכבת קריית מלאכי - יואב", "תימורים", "תלמי יחיאל", "תלמי יפה", "תלמים"],
    "נגב": ["אבו קרינאת", "אבו קרינאת והפזורה", "אבו תלול", "אבו-תלול והפזורה", "אום בטין", "אום בטין והפזורה", "אופקים", "אורים", "אזור תעשייה דימונה", "אזור תעשייה נ.ע.מ", "אזור תעשייה עידן הנגב", "אזור תעשייה רותם", "אל סייד", "אל פורעה", "אל-סייד והפזורה", "אשבול", "אשכולות", "אשל הנשיא", "אשלים", "אתר דודאים", "באר מילכה", "באר שבע - דרום", "באר שבע - מזרח", "באר שבע - מערב", "באר שבע - צפון", "בחלק מהאזורים בארץ", "בטחה", "ביר הדאג", "ביר הדאג'", "בית הגדי", "בית קמה", "ברוש", "גבעות בר", "גילת", "דביר", "דורות", "דימונה", "ואדי אל נעם דרום", "זרועה", "חורה", "חצרים", "טללים", "יושיביה", "יכיני", "ירוחם", "כמהין", "כסייפה", "כסייפה והפזורה", "כרמים", "כרמית", "להב", "להבים", "לקיה", "לקיה והפזורה", "מבועים", "מדרשת בן גוריון", "מיתר", "מסלול", "מעגלים, גבעולים, מלילות", "מצפה רמון", "מרחב עם", "מרעית", "משאבי שדה", "משמר הנגב", "נבטים", "ניצנה", "ניר משה", "ניר עקיבא", "נתיבות", "סנסנה", "סעווה", "עומר", "עזוז", "ערד", "ערערה בנגב", "פדויים", "פטיש", "פעמי תש''ז", "פעמי תש'ז", "קדש ברנע", "קלחים", "קסר א-סר", "קריית חינוך מרחבים", "רביבים", "רהט", "רהט והפזורה", "רוחמה", "רנן", "רתמים", "שאנטי במדבר", "שבי דרום", "שגב שלום", "שגב שלום והפזורה", "שדה בוקר", "שדה צבי", "שובל", "שומריה", "שיבולים", "שרשרת", "תארבין", "תאשור", "תדהר", "תל ערד", "תל שבע", "תלמי ביל''ו", "תלמי ביל'ו", "תפרח", "תקומה"],
    "עוטף עזה": ["אבשלום", "אור הנר", "אזור תעשייה הדרומי אשקלון", "איבים", "ארז", "בארי", "בני נצרים", "גבולות", "גבים", "גבים, מכללת ספיר", "דקל", "זיקים", "זמרת, שובה", "חולית", "חוף זיקים", "חניון רעים אנדרטת הנובה", "יבול", "יד מרדכי", "יתד", "כיסופים", "כפר מימון ותושיה", "כפר עזה", "כרם שלום", "כרמיה", "מבטחים, עמיעוז, ישע", "מגן", "מטווח ניר עם", "מכללת ספיר", "מפלסים", "נווה", "נחל עוז", "ניר יצחק", "ניר עוז", "ניר עם", "נירים", "נתיב העשרה", "סופה", "סעד", "עין הבשור", "עין השלושה", "עלומים", "פרי גן", "צאלים", "צוחר, אוהד", "רעים", "שדה ניצן", "שדי אברהם", "שדרות", "שדרות, איבים", "שוקדה", "שלומית", "תלמי אליהו", "תלמי יוסף"],
    "ערבה": ["אל עמארני, אל מסק", "אליפז ומכרות תמנע", "באר אורה", "גרופית", "חצבה", "יהל", "יטבתה", "לוטן", "נאות הכיכר", "נאות סמדר", "נווה חריף", "סמר", "ספיר", "עידן", "עין חצבה", "עין יהב", "עין תמר", "פארן", "צופר", "צוקים", "קטורה", "שחרות", "שיטים"],
    "שומרון": ["אביתר", "אזור תעשייה אריאל", "אזור תעשייה בראון", "אזור תעשייה ברקן", "אזור תעשייה שער בנימין", "אחיה", "איתמר", "אלון מורה", "אעירה השחר", "אריאל", "אש קודש", "בית אל", "בית אריה", "בני אדם", "ברוכין", "ברקן", "גבע בנימין", "גבעת אסף", "גבעת הראל", "גבעת הרואה", "גבעת פורת יוסף", "גופנה", "דולב", "החווה של זוהר", "הר ברכה", "חוות אביחי", "חוות אל נווה", "חוות אלחי", "חוות בניהו", "חוות גלעד", "חוות חנינא", "חוות יאיר", "חוות ינון", "חוות מגנזי", "חוות מלכיאל", "חוות מעלה אהוביה", "חוות נווה צוף", "חוות נוף אב'י", "חוות נוף אב'י", "חוות נחל שילה", "חוות נחלת צבי", "חוות עולם חסד", "חוות צרידה", "חוות ראש תאנה", "חוות שדה", "חוות שוביאל", "חוות שחרית", "חומש", "חרמש", "חרמש דרום", "חרשה", "טלמון", "יבוא דודי", "יצהר", "יקיר", "ירושלים - אזור תעשייה עטרות", "ירושלים - כפר עקב", "כוכב השחר", "כוכב יעקב", "כפר תפוח", "כרם רעים", "מבוא דותן", "מבואות יריחו", "מגדלים", "מגרון", "מכינת אלישע", "מלאכי השלום", "מעלה לבונה", "מעלה מכמש", "מצפה דני", "מצפה חגית", "נווה ארז", "נווה צוף", "נופי נחמיה", "נופים", "נחליאל", "נילי", "נעלה", "נריה", "עדי עד", "עופרים", "עטרת", "עלי", "עלי זהב - לשם", "עמיחי", "עמנואל", "ענב", "עפרה", "פדואל", "פסגות", "קדומים", "קידה", "קריית נטפים", "קרני שומרון", "רבבה", "רחלים", "רימונים", "רמת מגרון", "שבות רחל", "שבי שומרון", "שדה אפרים", "שילה", "תל ציון"],
    "שרון": ["אביאל", "אביחיל", "אבן יהודה", "אבני חפץ", "אודים", "אור עקיבא", "אורנית", "אזור תעשייה אפק ולב הארץ", "אזור תעשייה טירה", "אזור תעשייה כפר יונה", "אזור תעשייה עמק חפר", "אזור תעשייה קיסריה", "אחיטוב", "אייל", "אלוני יצחק", "אליכין", "אלישיב", "אלישמע", "אלפי מנשה", "אלקנה", "אמץ", "ארסוף", "בארותיים", "בורגתה", "בחן", "בי'ס כרמים בנימינה", "בי'ס כרמים בנימינה", "בית ברל", "בית הלוי", "בית חנניה", "בית חרות", "בית יהושע", "בית ינאי", "בית יצחק - שער חפר", "ביתן אהרן", "בני דרור", "בני ציון", "בנימינה", "בצרה", "ברקאי", "בת חן", "בת חפר", "ג'לג'וליה", "ג'סר א-זרקא", "גאולי תימן", "גאולים", "גבעת חיים איחוד", "גבעת חיים מאוחד", "גבעת חן", "גבעת עדה", "גבעת שפירא", "גן השומרון", "גן חיים", "גן יאשיה", "גן שמואל", "גנות הדר", "גני עם", "געש", "דורות עילית", "הדר עם", "הוד השרון", "המעפיל", "המרכז האקדמי רופין", "העוגן", "זכרון יעקב", "זמר", "חבצלת השרון וצוקי ים", "חגור", "חגלה", "חדרה - מזרח", "חדרה - מערב", "חדרה - מרכז", "חדרה - נווה חיים", "חופית", "חורשים", "חיבת ציון", "חניאל", "חרב לאת", "חרוצים", "חרות", "טייבה", "טירה", "יד חנה", "ינוב", "יעבץ, יעף", "יקום", "יקנעם המושבה והזורע", "ירחיב", "ירקונה", "כוכב יאיר - צור יגאל", "כפר ברא", "כפר גליקסון", "כפר הס", "כפר הרא''ה", "כפר הרא'ה", "כפר ויתקין", "כפר חיים", "כפר ידידיה", "כפר יונה", "כפר מונש", "כפר מל''ל", "כפר מל'ל", "כפר נטר", "כפר סבא", "כפר עבודה", "כפר פינס", "כפר קאסם", "כפר קרע", "כפר שמריהו", "להבות חביבה", "מאור", "מגל", "מכון וינגייט", "מכמורת", "מסוף אורנית", "מעברות", "מעגן מיכאל", "מעיין צבי", "מענית, גבעת חביבה", "מרכז אזורי דרום השרון", "משמר השרון", "משמרות", "משמרת", "מתחם שביל התפוזים", "מתן", "נווה ימין", "נווה ירק", "נורדיה", "ניצני עוז", "ניר אליהו", "נירית", "נמל קיסריה", "נעורים", "נתניה - מזרח", "נתניה - מערב", "סלעית", "עדנים", "עולש", "עזריאל", "עין החורש", "עין ורד", "עין עירון", "עין שמר", "עין שריד", "עץ אפרים", "פוריידיס", "פורת", "פרדס חנה כרכור", "פרדסיה", "צופים", "צופית", "צור יצחק", "צור משה", "צור נתן", "קדימה צורן", "קדימה-צורן", "קיסריה", "קלנסווה", "רמות השבים", "רמת הכובש", "רעננה", "רשפון", "שדה ורבורג", "שדה יצחק", "שדות ים", "שדי חמד", "שושנת העמקים", "שער אפרים", "שער מנשה", "שערי תקווה", "שפיים", "תחנת רכבת ראש העין", "תל יצחק", "תל מונד", "תלמי אלעזר", "תנובות"],
  };
