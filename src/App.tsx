...
export default function App() {
  ...
  const getCityCoords = (cityStr: string) => {
    ...
    "אילת": ["אזור תעשייה שחורת", "אילות", "אילת", "אליפז ומכרות תמנע", "באר אורה", "סמר"],
    "בקעת הירדן": ["ארגמן", "אש קודש", "בית חגלה", "בקעות", "בתרונות", "גיתית", "גלגל", "החווה של אורי כהן", "החווה של יאיא", "החווה של מנחם", "החווה של עשהאל", "חוות גנות", "חוות הרשאש", "חוות יד השומר", "חוות מרום שמואל", "חוות עמיאל", "חוות פריאל", "חמדת", "חמרה", "ייט''ב", "יפית", "מבואות יריחו", "מחולה", "מכורה", "מעלה אפרים", "מצפור פצאל", "משואה", "משכיות", "נעמה", "נערן", "נתיב הגדוד", "עינות קדם", "פצאל", "רועי", "רותם", "שדמות מחולה", "שלומציון", "תומר"],
    "גולן": ["אבני איתן", "אודם", "אורטל", "אזור תעשייה בני יהודה", "אזור תעשייה צמח", "אל רום", "אלוני הבשן", "אלי עד", "אלמגור", "אניעם", "אפיק", "אשדות יעקב", "בוקעתא", "בני יהודה וגבעת יואב", "גשור", "האון", "חד נס", "חמת גדר", "חספין", "יונתן", "כנף", "כפר חרוב", "כרכום", "מבוא חמה", "מג'דל שמס", "מיצר", "מסדה", "מסעדה", "מעגן", "מעלה גמלא", "מרום גולן", "נאות גולן", "נוב", "נווה אטי''ב", "נטור", "נמרוד", "עין גב", "עין זיוון", "עין קנייא", "צמח", "קדמת צבי", "קלע אלון", "קצרין", "קצרין - אזור תעשייה", "קשת", "רמות", "רמת טראמפ", "רמת מגשימים", "שניר", "שעל", "שער הגולן", "תל קציר"],
    "גליל מערבי": ["אבו סנאן", "אדמית", "איזור תעשייה מילואות צפון", "אילון", "אשרת", "בוסתן הגליל", "בית העלמין החדש נהריה", "בית העלמין החדש עכו", "בית העמק", "בן עמי", "בצת", "ג'דידה מכר", "ג'וליס", "גורן", "גורנות הגליל", "געתון", "גשר הזיו", "הילה", "חוף אכזיב", "חוף בצת", "חניתה", "טל - אל", "יחיעם", "יערה", "כברי", "כליל", "כפר יאסיף", "לוחמי הגטאות", "לימן", "מזרעה", "מנות", "מצובה", "נהריה", "נווה זיו", "נס עמים", "נתיב השיירה", "סער", "עבדון", "עברון", "עין יעקב", "עכו", "עכו - רמות ים", "עמקה", "ערב אל עראמשה", "ראש הנקרה", "רגבה", "שבי ציון", "שייח' דנון", "שלומי", "שמרת"],
    "גליל עליון": ["אביבים", "אבירים", "אבן מנחם", "אור הגנוז", "אזור תעשייה חצור הגלילית", "אזור תעשייה כרמיאל", "אזור תעשייה צ.ח.ר", "אזור תעשייה רמת דלתון", "אחיהוד", "איילת השחר", "אליפלט", "אלקוש", "אמירים", "אמנון", "ביריה", "בית ג'אן", "בית הלל", "בית ספר שדה מירון", "בענה", "בר יוחאי", "ברעם", "ג'ש - גוש חלב", "גדות", "גונן", "גיתה", "דוב''ב", "דיר אל-אסד", "דישון", "דלתון", "דפנה", "הגושרים", "הר חלוץ", "הר-חלוץ", "זרעית", "חולתה", "חוסן", "חורפיש", "חמדת ימים", "חצור הגלילית", "חרשים", "טובא זנגריה", "טל-אל", "ינוח ג'ת", "ינוח-ג'ת", "יסוד המעלה", "יסעור", "יפתח", "יראון", "ירכא", "כורזים ורד הגליל", "כחל", "כישור", "כמון - כמאנה מזרחית", "כסרא סמיע", "כפר בלום", "כפר גלעדי", "כפר הנשיא", "כפר ורדים", "כפר יובל", "כפר סאלד", "כפר שמאי", "כרם בן זמרה", "כרמיאל", "לב החולה", "לבון", "להבות הבשן", "לפידות", "מג'דל כרום", "מגדל תפן", "מחניים", "מטולה", "מירון", "מכמנים - כמאנה מערבית", "מלכיה", "מנחת מחניים", "מנרה", "מעונה", "מעיין ברוך", "מעיליא", "מעלות תרשיחא", "מרגליות", "מרכז אזורי מבואות חרמון", "מרכז אזורי מרום גליל", "מרכז אזורי רמת כורזים", "משגב עם", "משמר הירדן", "מתת", "נאות מרדכי", "נחף", "נטועה", "סאג'ור", "סאסא", "ספסופה - כפר חושן", "ע'ג'ר", "עין אל אסד", "עלמה", "עמוקה", "עמיעד", "עמיר", "פלך", "פסוטה", "פקיעין", "פקיעין החדשה", "פרוד", "צבעון", "צוריאל", "צורית גילון", "צפת - נוף כנרת", "צפת - עיר", "צפת - עכברה", "קדיתא", "קדרים", "קיבוץ דן", "קריית שמונה", "ראמה", "ראש פינה", "ריחאנייה", "רמות נפתלי", "שאר ישוב", "שדה אליעזר", "שדה נחמיה", "שומרה", "שזור", "שמיר", "שפר", "שתולה", "תובל", "תל חי"],
    ...
    "דן": ["אור יהודה", "אזור", "בית דגן", "בית עלמין מורשה", "בני ברק", "בת ים", "בת-ים", "גבעת השלושה", "גבעת שמואל", "גבעתיים", "גנות", "גני תקווה", "גת רימון", "הרצליה - מערב", "הרצליה - מרכז וגליל ים", "חולון", "חמד", "יגל", "יהוד מונוסון", "יהוד-מונוסון", "כפר סירקין", "כפר שמריהו", "מגשימים", "מעש", "מקווה ישראל", "משמר השבעה", "מתחם גלילות", "מתחם פי גלילות", "סביון", "פארק אריאל שרון", "פתח תקווה", "צפריה", "קריית אונו", "ראשון לציון - מזרח", "ראשון לציון - מערב", "רמת גן - מזרח", "רמת גן - מערב", "רמת השרון", "תל אביב - דרום העיר ויפו", "תל אביב - מזרח", "תל אביב - מרכז העיר", "תל אביב - עבר הירקון"],
    "הכרמל": ["אזור תעשייה יקנעם עילית", "אזור תעשייה מבוא כרמל", "בית אורן", "בית סוהר קישון", "בית צבי", "בת שלמה", "גבע כרמל", "גבעת וולפסון", "דלית אל כרמל", "הבונים", "זכרון יעקב", "כרם מהר''ל", "מאיר שפיה", "מגדים", "מעגן מיכאל", "מעיין צבי", "מרכז מיר''ב", "נווה ים", "עופר", "עין איילה", "עין הוד", "עין חוד", "עין כרמל", "עספיא", "עתלית", "פוריידיס", "צרופה", "תחנת רכבת כפר יהושוע"],
    "המפרץ": ["אורנים", "אושה", "אזור תעשייה ניר עציון", "אזור תעשייה קריית ביאליק", "אזור תעשייה שער נעמן", "איבטין", "אפק", "בית עלמין תל רגב", "בסמת טבעון", "החותרים", "חיפה - בת גלים ק.אליעזר", "חיפה - כרמל", "חיפה - מערב", "חיפה - מפרץ", "חיפה - נווה שאנן ורמות כרמל", "חיפה - קריית חיים ושמואל", "חיפה-מפרץ", "טירת כרמל", "יגור", "כפר ביאליק", "כפר גלים", "כפר המכבי", "כפר ח'וואלד", "כפר חסידים", "כפר מסריק", "נופית", "ניר עציון", "נשר", "סואעד חמירה", "עדי", "עין המפרץ", "עכו - אזור תעשייה", "קריית אתא", "קריית ביאליק", "קריית טבעון - בית זייד", "קריית ים", "קריית מוצקין", "ראס עלי", "רכסים", "רמת יוחנן", "שער העמקים"],
    "העמקים": ["אזור תעשייה אלון התבור", "אזור תעשייה מבואות הגלבוע", "אזור תעשייה ציפורית", "אחוזת ברק", "אילניה", "אכסאל", "אלון הגליל", "אלוני אבא", "אלונים", "בית אלפא וחפציבה", "בית השיטה", "בית יוסף", "בית לחם הגלילית", "בית קשת", "בית שאן", "בית שערים", "בלפוריה", "גבעת אלה", "גבת", "גדעונה", "גזית", "גן נר", "גני חוגה", "גניגר", "גשר", "דבוריה", "דברת", "דחי", "הושעיה", "היוגב", "הסוללים", "הרדוף", "זרזיר", "חג'אג'רה", "חמדיה", "טייבה בגלבוע", "טירת צבי", "טמרה בגלבוע", "יזרעאל", "יפיע", "יפעת", "ירדנה", "ישובי אומן", "ישובי יעל", "כדורי", "כעביה טבאש", "כפר ברוך", "כפר גדעון", "כפר גמילה מלכישוע", "כפר החורש", "כפר יהושע", "כפר יחזקאל", "כפר כנא", "כפר מצר", "כפר קיש", "כפר רופין", "כפר תבור", "כפר תקווה", "מגדל העמק", "מגן שאול", "מולדת", "מוקיבלה", "מזרע", "מירב", "מנחמיה", "מנשית זבדה", "מסילות", "מעוז חיים", "מעלה גלבוע", "מרחביה מושב", "מרחביה קיבוץ", "מרכז חבר", "משהד", "מתחם סקי גלבוע", "נאעורה", "נהלל", "נוה איתן", "נווה אור", "נוף הגליל", "נורית", "נין", "ניר דוד", "נצרת", "סולם", "סנדלה", "עילוט", "עין דור", "עין הנצי''ב", "עין מאהל", "עפולה", "ציפורי", "קבוצת גבע", "קריית טבעון-בית זייד", "רוויה", "רחוב", "ריינה", "רם און", "רמת דוד", "רמת ישי", "רמת צבי", "שדה אליהו", "שדה יעקב", "שדה נחום", "שדי תרומות", "שדמות דבורה", "שיבלי אום אלג'נם", "שמשית", "שריד", "תחנת רכבת כפר ברוך", "תל עדשים", "תל תאומים", "תמרת"],
    "השפלה": ["אבו-גוש", "אביעזר", "אדרת", "אזור תעשייה ברוש", "אזור תעשייה גדרה", "אזור תעשייה הר טוב - צרעה", "אזור תעשייה נשר - רמלה", "אחיסמך", "אחיעזר", "אירוס", "אשתאול", "באר יעקב", "בית גוברין", "בית חנן", "בית חשמונאי", "בית מאיר", "בית ניר", "בית עובד", "בית עוזיאל", "בית שמש", "בן שמן", "בקוע", "בר גיורא", "גאליה", "גבעות עדן", "גבעת יערים", "גבעת ישעיהו", "גזר", "גיבתון", "גיזו", "גינתון", "גלאון", "גן שורק", "גן שלמה", "גני הדר", "גני יוחנן", "גפן", "הראל", "זיתן", "זכריה", "זנוח", "חולדה", "טל שחר", "יד השמונה", "יד רמב''ם", "יסודות", "יציץ", "ישעי", "ישרש", "כסלון", "כפר אוריה", "כפר ביל''ו", "כפר בן נון", "כפר הנוער קריית יערים", "כפר זוהרים", "כפר חב''ד", "כפר מנחם", "כפר שמואל", "כרמי יוסף", "לוד", "לוזית", "לטרון", "מבוא ביתר", "מזכרת בתיה", "מחסיה", "מטע", "מיני ישראל - נחשון", "מסילת ציון", "מצליח", "משמר איילון", "משמר דוד", "נווה אילן", "נווה מיכאל - רוגלית", "נווה שלום", "נחושה", "נחם", "נחשון", "נטעים", "נטף", "ניר צבי", "נס הרים", "נס ציונה", "נען", "נצר חזני", "נצר סרני", "נתיב הל''ה", "סתריה", "עגור", "עזריה", "עיינות", "פארק תעשיות פלמחים", "פדיה", "פתחיה", "צור הדסה", "צלפון", "צפרירים", "צרעה", "קריית יערים", "קריית עקרון", "רחובות", "רטורנו - גבעת שמש", "רמות מאיר", "רמלה", "רמת רזיאל", "שדות מיכה", "שואבה", "שורש", "שריגים - לי-און", "תירוש", "תעוז", "תעשיון צריפין", "תרום"],
    "ואדי ערה": ["אביאל", "אום אל פחם", "אום אל קוטוף", "אזור תעשייה רגבים", "אזור תעשייה שחק", "אל עריאן", "אלוני יצחק", "אליקים", "באקה אל גרבייה", "בי'ס כרמים בנימינה", "ברטעה", "ברקאי", "ג'ת", "גבעת ניל''י", "גבעת עדה", "גבעת עוז", "גלעד", "דליה", "חוות אביה", "חוות אל נווה", "חיננית", "חריש", "חרמש", "חרמש דרום", "טל מנשה", "יקנעם המושבה והזורע", "יקנעם עילית", "כפר גליקסון", "כפר קרע", "מבוא דותן", "מגל", "מדרך עוז", "מועאוויה", "מי עמי", "מייסר", "מעלה עירון", "מצפה אילן", "מצר", "משמר העמק", "עין אל סהלה", "עין אל-סהלה", "עין העמק", "עין השופט", "עמיקם", "ערערה", "קיבוץ מגידו", "קציר", "רגבים", "ריחן", "רמות מנשה", "רמת השופט", "שקד"],
    "יהודה": ["אביגיל", "אדורה", "אדורים", "אזור תעשייה מיתרים", "איבי הנחל", "אלון שבות", "אליאב", "אלעזר", "אפקה", "אפרת", "אשתמוע", "בית הברכה", "בית חג'י", "בית יתיר", "ביתר עילית", "בני דקלים", "בר כוכבא", "בת עין", "גבעות", "הגבעה הצהובה", "היישוב היהודי חברון", "הר גילה", "הר עמשא", "חוות ארץ האיילים", "חוות אשכולות", "חוות דרומא", "חוות טואמין", "חוות טליה", "חוות יויו", "חוות מדבר חבר", "חוות מור ואברהם", "חוות מלאכי אברהם", "חוות מקנה יהודה", "חוות נחלת אבות", "חוות עדן", "חוות צאן קדר", "חוות קשואלה", "חוות תלם צפון", "טנא עומרים", "כפר אלדד", "כפר עציון", "כרמי צור", "כרמי קטיף ואמציה", "כרמל", "מגדל עוז", "מיצד", "מעון", "מעלה חבר", "מעלה עמוס", "מעלה רחבעם", "מצפה זי'ו", "מצפה יאיר", "נגוהות", "נווה דניאל", "נוקדים", "נטע", "סוסיא", "סוסיא הקדומה", "עוז וגאון", "עשהאל", "עתניאל", "פארק תעשיות מגדל עוז", "פני קדם", "צומת הגוש", "קרית ארבע", "ראש צורים", "שדה בועז", "שדה בר", "שומריה", "שמעה", "שני ליבנה", "שקף", "תלם", "תקוע", "תקוע ד' וה"],
    "ים המלח": ["אבנת", "אל פורעה", "בתי מלון ים המלח", "חוות מנחם", "כפר הנוקדים", "מלונות ים המלח מרכז", "מצדה", "מצוקי דרגות", "מצפה מדרג", "מצפה שלם", "מרחצאות עין גדי", "נאות הכיכר", "נווה זוהר", "עין בוקק", "עין גדי", "עין תמר", "ערד", "קליה"],
    "ירושלים": ["אבו גוש", "אבן ספיר", "אורה", "אזור תעשייה מישור אדומים", "אזור תעשייה שער בנימין", "אלון", "אלמוג", "בית הערבה", "בית זית", "בית חורון", "בית נקופה", "בני אדם", "גבע בנימין", "גבעון החדשה", "גבעת זאב", "הר אדר", "ורד יריחו", "חוות בניהו", "חוות הרועה העברי", "חוות ינון", "חוף קליה", "ירושלים - אזור תעשייה עטרות", "ירושלים - דרום", "ירושלים - כפר עקב", "ירושלים - מזרח", "ירושלים - מערב", "ירושלים - מרכז", "ירושלים - צפון", "ירושלים - צפון ואלונים", "כפר אדומים", "מבשרת ציון", "מוצא עילית", "מעלה אדומים", "מעלה החמישה", "מצפה חגית", "מצפה יריחו", "מרכז אזורי מגילות", "נופי פרת", "עין נקובא", "עין ראפה", "עלמון", "עמינדב", "פנימיית עין כרם", "צובה", "צומת אלמוג", "קדם ערבה", "קדר", "קדר דרום", "קריית ענבים"],
    "ירקון": ["אזור תעשייה אפק ולב הארץ", "אזור תעשייה חבל מודיעין שוהם", "איירפורט סיטי", "אלעד", "בארות יצחק", "בית נחמיה", "בית עריף", "בני עטרות", "ברקת", "גבעת כ''ח", "גמזו", "חדיד", "חוות מגנזי", "חוות עולם חסד", "חשמונאים", "טירת יהודה", "כפר דניאל", "כפר האורנים", "כפר טרומן", "כפר נוער בן שמן", "כפר רות", "לפיד", "מבוא חורון", "מבוא מודיעים", "מודיעין - ישפרו סנטר", "מודיעין - ליגד סנטר", "מודיעין מכבים רעות", "מודיעין עילית", "מזור", "מתתיהו", "נאות קדומים", "נוף איילון", "נופך", "נחלים", "נחשונים", "נילי", "עינת", "ראש העין", "רינתיה", "שוהם", "שילת", "שעלבים"],
    "לכיש": ["אביגדור", "אבן שמואל", "אורות", "אזור תעשייה באר טוביה", "אזור תעשייה הדרומי אשקלון", "אזור תעשייה כנות", "אזור תעשייה עד הלום", "אזור תעשייה צפוני אשקלון", "אזור תעשייה קריית גת", "אזור תעשייה רבדים", "אזור תעשייה תימורים", "אחווה", "אחוזם", "איתן", "אל עזי", "אלומה", "אמונים", "אשדוד - א", "אשדוד - אזור תעשייה צפוני ונ", "אשדוד - איזור תעשייה צפוני", "אשדוד - ג", "אשדוד - ח", "אשדוד - יא", "אשדוד -יא", "אשדוד סיטי", "אשקלון", "אשקלון - דרום", "אשקלון - צפון", "באר גנים", "באר טוביה", "ביצרון", "בית אלעזרי", "בית גמליאל", "בית חלקיה", "בית עזרא", "בית שקמה", "בן זכאי", "בני דרום", "בני עי''ש", "בני ראם", "בניה", "ברור חיל", "ברכיה", "בת הדר", "גבעת ברנר", "גבעת וושינגטון", "גבעתי", "גברעם", "גדרה", "גיאה", "גן הדרום", "גן יבנה", "גני טל", "גת", "ד", "הודיה", "ורדון", "זבדיאל", "זוהר", "זרחיה", "חלץ", "חפץ חיים", "חצב", "חצור", "טו", "יב", "יבנה", "יד בנימין", "יד נתן", "ינון", "כוכב מיכאל", "כנות", "כפר אביב", "כפר אחים", "כפר הנגיד", "כפר הרי''ף וצומת ראם", "כפר ורבורג", "כפר מרדכי", "כפר סילבר", "כרם ביבנה", "לכיש", "מבקיעים", "מישר", "מנוחה", "מעון צופיה", "מרינה", "מרכז שפירא", "משגב דב", "משואות יצחק", "משען", "מתחם בני דרום", "נגבה", "נהורה", "נוגה", "נווה מבטח", "נועם", "נחלה", "ניצן", "ניצנים", "ניר בנים", "ניר גלים", "ניר ח''ן", "ניר ישראל", "סגולה", "עוזה", "עוצם", "עזר", "עזריקם", "עין צורים", "ערוגות", "עשרת", "פארק תעשייה ראם", "פלמחים", "קבוצת יבנה", "קדמה", "קדרון", "קוממיות", "קריית גת", "קריית מלאכי", "רבדים", "רווחה", "שדה דוד", "שדה יואב", "שדה משה", "שדה עוזיהו", "שדמה", "שחר", "שלווה", "שפיר", "שתולים", "תחנת רכבת קריית מלאכי - יואב", "תימורים", "תלמי יחיאל", "תלמי יפה", "תלמים"],
    "נגב": ["אבו קרינאת", "אבו קרינאת והפזורה", "אבו תלול", "אבו-תלול והפזורה", "אום בטין", "אום בטין והפזורה", "אופקים", "אזור תעשייה דימונה", "אזור תעשייה נ.ע.מ", "אזור תעשייה עידן הנגב", "אזור תעשייה רותם", "אל סייד", "אל-סייד והפזורה", "אשבול", "אשכולות", "אשל הנשיא", "אשלים", "אתר דודאים", "באר שבע - דרום", "באר שבע - מזרח", "באר שבע - מערב", "באר שבע - צפון", "בחלק מהאזורים בארץ", "בטחה", "ביר הדאג", "בית הגדי", "בית קמה", "ברוש", "גבעות בר", "גילת", "דביר", "דורות", "דימונה", "ואדי אל נעם דרום", "זרועה", "חורה", "חירן", "חצרים", "טללים", "יושיביה", "ירוחם", "כמהין", "כסייפה", "כסייפה והפזורה", "כרמים", "כרמית", "להב", "להבים", "לקיה", "לקיה והפזורה", "מבועים", "מדרשת בן גוריון", "מיתר", "מסלול", "מרחב עם", "מרעית", "משאבי שדה", "משמר הנגב", "נבטים", "ניצנה", "ניר משה", "ניר עקיבא", "סנסנה", "סעווה", "עומר", "עזוז", "ערערה בנגב", "פדויים", "פעמי תש''ז", "צאלים", "קדש ברנע", "קלחים", "קסר א-סר", "קריית חינוך מרחבים", "רביבים", "רהט", "רהט והפזורה", "רוחמה", "רנן", "רתמים", "שאנטי במדבר", "שבי דרום", "שגב שלום", "שגב שלום והפזורה", "שדה בוקר", "שדה צבי", "שובל", "שיבולים", "שרשרת", "תארבין", "תאשור", "תדהר", "תל ערד", "תל שבע", "תלמי ביל''ו", "תפרח"],
    "עוטף עזה": ["אבשלום", "אור הנר", "אורים", "איבים", "ארז", "באר מילכה", "בארי", "בני נצרים", "גבולות", "גבים", "דקל", "זיקים", "חולית", "חוף זיקים", "חניון רעים אנדרטת הנובה", "יבול", "יד מרדכי", "יכיני", "יתד", "כיסופים", "כפר מימון ותושיה", "כפר עזה", "כרם שלום", "כרמיה", "מגן", "מטווח ניר עם", "מכללת ספיר", "מפלסים", "נווה", "נחל עוז", "ניר יצחק", "ניר עוז", "ניר עם", "נירים", "נתיב העשרה", "נתיבות", "סופה", "סעד", "עין הבשור", "עין השלושה", "עלומים", "פטיש", "פרי גן", "רעים", "שדה ניצן", "שדי אברהם", "שדרות", "שוקדה", "שלומית", "תלמי אליהו", "תלמי יוסף", "תקומה"],
    "ערבה": ["גרופית", "חצבה", "יהל", "יטבתה", "לוטן", "מצפה רמון", "נאות סמדר", "נווה חריף", "ספיר", "עידן", "עין חצבה", "עין יהב", "פארן", "צופר", "צוקים", "קטורה", "שחרות", "שיטים"],
    "שומרון": ["אביתר", "אזור תעשייה אריאל", "אזור תעשייה בראון", "אזור תעשייה ברקן", "אחיה", "איתמר", "אלון מורה", "אעירה השחר", "אריאל", "בית אל", "בית אריה", "ברוכין", "ברקן", "גבעת אסף", "גבעת הראל", "גבעת הרואה", "גבעת פורת יוסף", "גופנה", "דולב", "דורות עילית", "החווה של זוהר", "הר ברכה", "חוות אביחי", "חוות אלחי", "חוות גלעד", "חוות חנינא", "חוות יאיר", "חוות מגדלים", "חוות מלכיאל", "חוות מעלה אהוביה", "חוות נווה צוף", "חוות נוף אב'י", "חוות נחל שילה", "חוות נחלת צבי", "חוות צרידה", "חוות ראש תאנה", "חוות שדה", "חוות שוביאל", "חוות שחרית", "חומש", "חרשה", "טלמון", "יבוא דודי", "יצהר", "יקיר", "כוכב השחר", "כוכב יעקב", "כפר תפוח", "כרם רעים", "מגדלים", "מגרון", "מכינת אלישע", "מלאכי השלום", "מעלה לבונה", "מעלה מכמש", "מצפה דני", "נווה ארז", "נווה צוף", "נופי נחמיה", "נופים", "נחליאל", "נעלה", "נריה", "עדי עד", "עופרים", "עטרת", "עלי", "עלי זהב - לשם", "עמיחי", "עמנואל", "ענב", "עפרה", "פדואל", "פסגות", "קדומים", "קידה", "קריית נטפים", "קרני שומרון", "רבבה", "רחלים", "רימונים", "רמת מגרון", "שבות רחל", "שבי שומרון", "שדה אפרים", "שילה", "תל ציון"],
    "שרון": ["אביחיל", "אבן יהודה", "אבני חפץ", "אודים", "אור עקיבא", "אורנית", "אזור תעשייה טירה", "אזור תעשייה כפר יונה", "אזור תעשייה עמק חפר", "אזור תעשייה קיסריה", "אחיטוב", "אייל", "אליכין", "אלישיב", "אלישמע", "אלפי מנשה", "אלקנה", "אמץ", "ארסוף", "בארותיים", "בורגתה", "בחן", "בי'ס כרמים בנימינה", "בית ברל", "בית הלוי", "בית חנניה", "בית חרות", "בית יהושע", "בית ינאי", "בית יצחק - שער חפר", "ביתן אהרן", "בני דרור", "בני ציון", "בנימינה", "בצרה", "בת חן", "בת חפר", "ג'לג'וליה", "ג'סר א-זרקא", "גאולי תימן", "גאולים", "גבעת חיים איחוד", "גבעת חיים מאוחד", "גבעת חן", "גבעת שפירא", "גן השומרון", "גן חיים", "גן יאשיה", "גן שמואל", "גנות הדר", "גני עם", "געש", "הדר עם", "הוד השרון", "המעפיל", "המרכז האקדמי רופין", "העוגן", "זמר", "חבצלת השרון וצוקי ים", "חגור", "חגלה", "חדרה - מזרח", "חדרה - מערב", "חדרה - מרכז", "חדרה - נווה חיים", "חופית", "חורשים", "חיבת ציון", "חניאל", "חרב לאת", "חרוצים", "חרות", "טייבה", "טירה", "יד חנה", "ינוב", "יקום", "ירחיב", "ירקונה", "כוכב יאיר - צור יגאל", "כפר ברא", "כפר הס", "כפר הרא''ה", "כפר ויתקין", "כפר חיים", "כפר ידידיה", "כפר יונה", "כפר מונש", "כפר מל''ל", "כפר נטר", "כפר סבא", "כפר עבודה", "כפר פינס", "כפר קאסם", "להבות חביבה", "מאור", "מכון וינגייט", "מכמורת", "מסוף אורנית", "מעברות", "מרכז אזורי דרום השרון", "משמר השרון", "משמרות", "משמרת", "מתחם שביל התפוזים", "מתן", "נווה ימין", "נווה ירק", "נורדיה", "ניצני עוז", "ניר אליהו", "נירית", "נמל קיסריה", "נעורים", "נתניה - מזרח", "נתניה - מערב", "סלעית", "עדנים", "עולש", "עזריאל", "עין החורש", "עין ורד", "עין עירון", "עין שמר", "עין שריד", "עץ אפרים", "פורת", "פרדס חנה כרכור", "פרדסיה", "צופים", "צופית", "צור יצחק", "צור משה", "צור נתן", "קדימה צורן", "קדימה-צורן", "קיסריה", "קלנסווה", "רמות השבים", "רמת הכובש", "רעננה", "רשפון", "שדה ורבורג", "שדה יצחק", "שדות ים", "שדי חמד", "שושנת העמקים", "שער אפרים", "שער מנשה", "שערי תקווה", "שפיים", "תחנת רכבת ראש העין", "תל יצחק", "תל מונד", "תלמי אלעזר", "תנובות"],
  };
